<!-- GENERATED FROM: asl/block/model/dispatch/sorting-schema.asl -->
# Sorting Schema

**Normative ASL source:** `asl/block/model/dispatch/sorting-schema.asl`

This page is a generated reference view of the normative ASL unit.

## ASL unit identity {#PTO-BLOCK-MODEL-DISPATCH-SORTING-SCHEMA}

## Normative ASL

<!-- GENERATED-ASL-BEGIN: unit source=asl/block/model/dispatch/sorting-schema.asl -->
```asl

<!-- GENERATED FROM: asl/block/model/dispatch/partial-schema.asl -->
# Partial Schema

**Normative ASL source:** `asl/block/model/dispatch/partial-schema.asl`

This page is a generated reference view of the normative ASL unit.

## ASL unit identity {#PTO-BLOCK-MODEL-DISPATCH-PARTIAL-SCHEMA}
...
<!-- GENERATED-ASL-BEGIN: unit source=asl/block/model/dispatch/partial-schema.asl -->
```asl

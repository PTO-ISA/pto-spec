<!-- GENERATED FROM: asl/block/model/schema/profile-encoding.asl -->
# Profile Encoding

**Normative ASL source:** `asl/block/model/schema/profile-encoding.asl`

This page is a generated reference view of the normative ASL unit.

## ASL unit identity {#PTO-BLOCK-MODEL-SCHEMA-PROFILE-ENCODING}

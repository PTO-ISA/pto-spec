...
{
  "schema_version": 1,
  "id": "intrinsic.tprefetch_async",
  "kind": "intrinsic",
  "title": "TPREFETCH_ASYNC Intrinsic Status",
  "status": "unmapped",
  "visibility": "internal",
  "profile": "pto-isa-0.58.0",
  "opcode": "TPREFETCH_ASYNC",
  "family": "memory-tlsu",
  "sources": {
    "davincioo": "status/unmapped/TPREFETCH_ASYNC.md",
    "pto": "tile/ops/memory-and-data-movement/tprefetch-async.md"
  },
  "xlsx": {
    "include": false
  }
...
---
# TPREFETCH_ASYNC Intrinsic Status
...
- PTO ISA source: `tile/ops/memory-and-data-movement/tprefetch-async.md`

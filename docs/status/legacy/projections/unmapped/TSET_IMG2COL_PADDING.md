...
{
  "schema_version": 1,
  "id": "intrinsic.tset_img2col_padding",
  "kind": "intrinsic",
  "title": "TSET_IMG2COL_PADDING Intrinsic Status",
  "status": "unmapped",
  "visibility": "internal",
  "profile": "pto-isa-0.58.0",
  "opcode": "TSET_IMG2COL_PADDING",
  "family": "sync-config",
  "sources": {
    "davincioo": "status/unmapped/TSET_IMG2COL_PADDING.md",
    "pto": "tile/ops/sync-and-config/set-img2col-padding.md"
  },
  "xlsx": {
    "include": false
  }
...
---
# TSET_IMG2COL_PADDING Intrinsic Status
...
- PTO ISA source: `tile/ops/sync-and-config/set-img2col-padding.md`

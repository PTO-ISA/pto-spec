...
{
  "schema_version": 1,
  "id": "intrinsic.tsethf32mode",
  "kind": "intrinsic",
  "title": "TSETHF32MODE Intrinsic Status",
  "status": "unmapped",
  "visibility": "internal",
  ...
  "family": "sync-config",
  "sources": {
    "davincioo": "status/unmapped/TSETHF32MODE.md",
    "pto": "tile/ops/sync-and-config/sethf32mode.md"
  },
  "xlsx": {
    "include": false
  }
...
- PTO ISA source: `tile/ops/sync-and-config/sethf32mode.md`

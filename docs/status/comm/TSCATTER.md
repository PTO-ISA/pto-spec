...
{
  "schema_version": 1,
  "id": "intrinsic.comm-tscatter",
  "kind": "intrinsic",
  "title": "comm/TSCATTER Intrinsic Status",
  "status": "unmapped",
  "visibility": "internal",
  "profile": "pto-isa-0.58.0",
  "opcode": "comm/TSCATTER",
  "family": "communication",
  "sources": {
    "davincioo": "status/comm/TSCATTER.md",
    "pto": "comm/TSCATTER.md"
  },
  "xlsx": {
    "include": false
  }
...
---
# comm/TSCATTER Intrinsic Status

> 状态：当前 DavinciOO 尚未映射，本页不是 normative encoding 定义。

## PTO 语义来源

- PTO ISA source: `comm/TSCATTER.md`

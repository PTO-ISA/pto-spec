...
{
  "schema_version": 1,
  "id": "intrinsic.comm-tget_async",
  "kind": "intrinsic",
  "title": "comm/TGET_ASYNC Intrinsic Status",
  "status": "unmapped",
  "visibility": "internal",
  "profile": "pto-isa-0.58.0",
  "opcode": "comm/TGET_ASYNC",
  "family": "communication",
  "sources": {
    "davincioo": "status/comm/TGET_ASYNC.md",
    "pto": "comm/TGET_ASYNC.md"
  },
  "xlsx": {
    "include": false
  }
...
---
# comm/TGET_ASYNC Intrinsic Status

> 状态：当前 DavinciOO 尚未映射，本页不是 normative encoding 定义。

## PTO 语义来源

- PTO ISA source: `comm/TGET_ASYNC.md`

...
{
  "schema_version": 1,
  "id": "intrinsic.comm-tgather",
  "kind": "intrinsic",
  "title": "comm/TGATHER Intrinsic Status",
  "status": "unmapped",
  "visibility": "internal",
  ...
  "sources": {
    "davincioo": "status/comm/TGATHER.md",
    "pto": "comm/TGATHER.md"
  },
  "xlsx": {
    "include": false
...
---
# comm/TGATHER Intrinsic Status

> 状态：当前 DavinciOO 尚未映射，本页不是 normative encoding 定义。

## PTO 语义来源

- PTO ISA source: `comm/TGATHER.md`

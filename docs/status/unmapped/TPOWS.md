---
{
  ...
  "family": "tile-scalar",
  "sources": {
    "davincioo": "status/unmapped/TPOWS.md",
    "pto": "tile/ops/tile-scalar-and-immediate/tpows.md"
  },
  "xlsx": {
    "include": false
  }
...
---
# TPOWS Intrinsic Status

> 状态：当前 DavinciOO 尚未映射，本页不是 normative encoding 定义。

## PTO 语义来源

- PTO ISA source: `tile/ops/tile-scalar-and-immediate/tpows.md`

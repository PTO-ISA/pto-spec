---
{
  ...
  "sources": {
    "davincioo": "status/unmapped/TPACK.md",
    "pto": "tile/ops/layout-and-rearrangement/tpack.md"
  },
  "xlsx": {
    "include": false
  }
...
---
# TPACK Intrinsic Status

> 状态：当前 DavinciOO 尚未映射，本页不是 normative encoding 定义。

## PTO 语义来源

- PTO ISA source: `tile/ops/layout-and-rearrangement/tpack.md`

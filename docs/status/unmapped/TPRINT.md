---
{
  ...
  "sources": {
    "davincioo": "status/unmapped/TPRINT.md",
    "pto": "tile/ops/irregular-and-complex/tprint.md"
  },
  "xlsx": {
    "include": false
  }
...
---
# TPRINT Intrinsic Status

> 状态：当前 DavinciOO 尚未映射，本页不是 normative encoding 定义。

## PTO 语义来源

- PTO ISA source: `tile/ops/irregular-and-complex/tprint.md`

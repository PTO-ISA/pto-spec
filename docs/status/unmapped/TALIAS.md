---
{
  ...
  "family": "sync-config",
  "sources": {
    "davincioo": "status/unmapped/TALIAS.md",
    "pto": "tile/ops/sync-and-config/talias.md"
  },
  "xlsx": {
    "include": false
  }
...
---
# TALIAS Intrinsic Status

> 状态：当前 DavinciOO 尚未映射，本页不是 normative encoding 定义。

## PTO 语义来源

- PTO ISA source: `tile/ops/sync-and-config/talias.md`

...
{
  "schema_version": 1,
  "id": "intrinsic.tsettf32mode",
  "kind": "intrinsic",
  "title": "TSETTF32MODE Intrinsic Status",
  "status": "unmapped",
  "visibility": "internal",
  ...
  "family": "sync-config",
  "sources": {
    "davincioo": "status/unmapped/TSETTF32MODE.md",
    "pto": "tile/ops/sync-and-config/settf32mode.md"
  },
  "xlsx": {
    "include": false
  }
...
---
# TSETTF32MODE Intrinsic Status

> 状态：当前 DavinciOO 尚未映射，本页不是 normative encoding 定义。

## PTO 语义来源

- PTO ISA source: `tile/ops/sync-and-config/settf32mode.md`

<!-- GENERATED FROM: asl/arch/profile/linx-runtime-compat.asl -->
# Linx Runtime Compat

**Normative ASL source:** `asl/arch/profile/linx-runtime-compat.asl`

This page is a generated reference view of the normative ASL unit.

## ASL unit identity {#PTO-ARCH-PROFILE-LINX-RUNTIME-COMPAT}
...
<!-- GENERATED-ASL-BEGIN: unit source=asl/arch/profile/linx-runtime-compat.asl -->
```asl
...
// ndf: kind=contract level=L1 layer=concurrency status=open
...
// ndf: kind=contract level=L1 layer=memory status=open

...
| CUBE | 12 operations with explicit destination and optional accumulator input | Stage 4 raw-carrier reference totality closed; logical/physical ACC contract defined; Stage 5 conformance open | all-12 decoded results, all-25 type identities, mixed layouts/locations, aliases, ACC input/update/conversion/release, trap preservation, and composite preflight | named hardware accumulation, rounding, saturation, exceptional-value, and numeric conformance |

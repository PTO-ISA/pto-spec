...
<!-- SUPPLEMENTARY-BEGIN -->
<!-- PTO-READER-BLOCK: scalar-sd-add-purpose role=purpose -->
## What SD.ADD does

`SD.ADD` atomically applies modular addition to one doubleword and stores the result without publishing the old value.

<!-- PTO-READER-BLOCK: scalar-sd-add-mechanism role=mechanism -->
## Atomic mechanism
...
<!-- PTO-READER-BLOCK: scalar-sd-add-inputs-outputs role=inputs-outputs -->
## Inputs and result
...
<!-- PTO-READER-BLOCK: scalar-sd-add-effects role=effects -->
...
<!-- PTO-READER-BLOCK: scalar-sd-add-constraints role=constraints -->
...
<!-- PTO-READER-BLOCK: scalar-sd-add-example role=example -->
## Non-normative example

This example only shows one accepted spelling; the generated contract below remains authoritative.

For a first reading, use `sd.add [SrcL], SrcR` and then vary only the ordering or route modifiers described above.
<!-- SUPPLEMENTARY-END -->

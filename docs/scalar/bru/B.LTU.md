<!-- GENERATED FROM: asl/scalar/bru/B.LTU.asl -->
# B.LTU

**Normative ASL source:** `asl/scalar/bru/B.LTU.asl`
...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| b_ltu_32_f1ea7ad44e37 | SrcL | 5 | 0–31 | none | none | left absolute GPR source | Encoded zero names the architectural zero GPR. |
| b_ltu_32_f1ea7ad44e37 | SrcR | 5 | 0–31 | none | none | right absolute GPR source | Encoded zero names the architectural zero GPR. |
| b_ltu_32_f1ea7ad44e37 | simm12 | 12 | 0–4095 | none | none | 12-bit signed immediate or displacement | Encoded zero supplies numeric zero for the 12-bit signed immediate or displacement. |

<!-- GENERATED FROM: asl/scalar/bru/B.EQ.asl -->
# B.EQ

**Normative ASL source:** `asl/scalar/bru/B.EQ.asl`
...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| b_eq_32_41f00e5abd89 | SrcL | 5 | 0–31 | none | none | left absolute GPR source | Encoded zero names the architectural zero GPR. |
| b_eq_32_41f00e5abd89 | SrcR | 5 | 0–31 | none | none | right absolute GPR source | Encoded zero names the architectural zero GPR. |
| b_eq_32_41f00e5abd89 | simm12 | 12 | 0–4095 | none | none | 12-bit signed immediate or displacement | Encoded zero supplies numeric zero for the 12-bit signed immediate or displacement. |

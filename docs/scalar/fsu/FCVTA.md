...
FCVTA converts a selected FP64 or FP32 carrier to UD/UW/UH/UB or SD/SW/SH/SB with fixed round-away mode.
...
`FCVTA` converts FP64 or FP32 input to raw DstType codes `0..7` (UD/UW/UH/UB or SD/SW/SH/SB) with fixed round-to-nearest, ties-away through the active numeric profile.
...
| --- | --- | ---: | --- | --- |
| fcvta_32_010837b9acbd | L32 | 32 | 0x0000106b / 0x01f0707f | [{"field":"SrcType","operator":"one-of","values":[0,1]},{"field":"DstType","operator":"one-of","values":[0,1,2,3,4,5,6,7]}] |

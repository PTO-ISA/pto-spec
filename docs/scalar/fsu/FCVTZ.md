...
`FCVTZ` converts FP64, FP32, FP16, or E4M3 input to raw DstType codes `0..7` (UD/UW/UH/UB or SD/SW/SH/SB) with fixed round-toward-zero through the active numeric profile.
...
| --- | --- | ---: | --- | --- |
| fcvtz_32_bee01d31217c | L32 | 32 | 0x0000506b / 0x01f0707f | [{"field":"DstType","operator":"one-of","values":[0,1,2,3,4,5,6,7]}] |
...
| fcvtz_32_bee01d31217c | SrcType | 2 | 0–3 | none | none | source carrier selector | Encoded zero selects the 64-bit source carrier; it is not omission. |

...
`FLT` performs ordered quiet less-than and publishes canonical XLEN one or zero.
...
`flt.fd a0, a1, ->a2` applies the architecture-owned special-value rule and publishes canonical output before advancing `TPC`.
<!-- SUPPLEMENTARY-END -->

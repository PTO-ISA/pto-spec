...
<!-- SUPPLEMENTARY-BEGIN -->
<!-- PTO-READER-BLOCK: scalar-fmin-purpose role=purpose -->
## What FMIN does

`FMIN` applies architecture-owned ordered minimum, NaN, and signed-zero rules to selected carriers.

<!-- PTO-READER-BLOCK: scalar-fmin-mechanism role=mechanism -->
## Numeric mechanism
...
Signed-zero selection follows the architecture-owned `FMIN` rule.

<!-- PTO-READER-BLOCK: scalar-fmin-inputs-outputs role=inputs-outputs -->
## Inputs and output
...
<!-- PTO-READER-BLOCK: scalar-fmin-effects role=effects -->
...
<!-- PTO-READER-BLOCK: scalar-fmin-constraints role=constraints -->
...
<!-- PTO-READER-BLOCK: scalar-fmin-example role=example -->
...
`fmin.fd a0, a1, ->a2` applies the architecture-owned special-value rule and publishes canonical output before advancing `TPC`.
<!-- SUPPLEMENTARY-END -->

...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| hl_maddw_48_6fac897f0264 | RegDst0 | 5 | 0–31 | none | none | low product or accumulator Reg5 destination | Encoded zero discards the low result. |
| hl_maddw_48_6fac897f0264 | RegDst1 | 5 | 0–31 | none | none | high product or accumulator Reg5 destination | Encoded zero discards the high result. |
...
- Sign-extend SrcD[31:0], SrcL[31:0], and SrcR[31:0] to XLEN; compute a signed 128-bit product and add the sign-extended addend modulo 2^128.

...
<!-- SUPPLEMENTARY-BEGIN -->
<!-- PTO-READER-BLOCK: scalar-hl-lhui-u-purpose role=purpose -->
## What HL.LHUI.U does

`HL.LHUI.U` is a standalone `48`-bit scalar AGU instruction that loads one 2-byte little-endian value and zero-extends the transferred bits when the result is narrower than `PTO_XLEN` using `Immediate` addressing.

<!-- PTO-READER-BLOCK: scalar-hl-lhui-u-mechanism role=mechanism -->
...
<!-- PTO-READER-BLOCK: scalar-hl-lhui-u-inputs role=inputs-outputs -->
...
<!-- PTO-READER-BLOCK: scalar-hl-lhui-u-effects role=effects -->
...
After all result or writeback publication, `HL.LHUI.U` advances `TPC` by `6` bytes; a rejected or faulting attempt does not retire.

<!-- PTO-READER-BLOCK: scalar-hl-lhui-u-constraints role=constraints -->
...
<!-- PTO-READER-BLOCK: scalar-hl-lhui-u-example role=example -->
## Non-normative reading walkthrough

This walkthrough explains how to use the page and does not add instruction behavior.

- Start with the canonical assembly `hl.lhui.u [SrcL, simm], ->{t, u, Rd}` and identify the encoded address fields.
...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| hl_lhui_u_48_d75649bac1c7 | RegDst | 5 | 0–31 | none | none | Reg5 loaded-value destination or discard | Encoded zero discards this result without suppressing the instruction's other effects. |
| hl_lhui_u_48_d75649bac1c7 | SrcL | 5 | 0–31 | none | none | Reg5 address-base source | Encoded zero reads the architectural zero GPR. |
| hl_lhui_u_48_d75649bac1c7 | simm22 | 22 | 0–4194303 | none | none | signed address displacement | Encoded zero supplies a zero displacement; it does not denote omission. |

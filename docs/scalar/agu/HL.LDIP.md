<!-- GENERATED FROM: asl/scalar/agu/HL.LDIP.asl -->
# HL.LDIP
...
`HL.LDIP` is a standalone `48`-bit scalar AGU instruction that loads two adjacent 8-byte little-endian values and zero-extends each transferred value when it is narrower than `PTO_XLEN` using `Immediate` addressing.
...
After all result or writeback publication, `HL.LDIP` advances `TPC` by `6` bytes; a rejected or faulting attempt does not retire.
...
- Start with the canonical assembly `hl.ldip [SrcL, simm], ->Dst0, Dst1` and identify the encoded address fields.
...
| --- | --- | ---: | --- | --- |
| hl_ldip_48_60afa6423d39 | HL48 | 48 | 0x00003019001e / 0x0000707f003f | [] |

### Fields

| Form | Field | Bits | Signedness | Pieces |
| --- | --- | ---: | --- | --- |
| hl_ldip_48_60afa6423d39 | RegDst0 | 5 | encoding-defined | [{"instruction_lsb":23,"value_lsb":0,"width":5}] |
| hl_ldip_48_60afa6423d39 | RegDst1 | 5 | encoding-defined | [{"instruction_lsb":11,"value_lsb":0,"width":5}] |
...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| hl_ldip_48_60afa6423d39 | RegDst0 | 5 | 0–31 | none | none | Reg5 first loaded-value destination or discard | Encoded zero discards this result without suppressing the instruction's other effects. |
| hl_ldip_48_60afa6423d39 | RegDst1 | 5 | 0–31 | none | none | Reg5 second loaded-value destination or discard | Encoded zero discards this result without suppressing the instruction's other effects. |
| hl_ldip_48_60afa6423d39 | SrcL | 5 | 0–31 | none | none | Reg5 address-base source | Encoded zero reads the architectural zero GPR. |
| hl_ldip_48_60afa6423d39 | simm17 | 17 | 0–131071 | none | none | signed address displacement | Encoded zero supplies a zero displacement; it does not denote omission. |
...
<!-- GENERATED-ASL-BEGIN: operation source=asl/scalar/agu/HL.LDIP.asl -->
```asl

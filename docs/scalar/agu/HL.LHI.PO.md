...
<!-- SUPPLEMENTARY-BEGIN -->
<!-- PTO-READER-BLOCK: scalar-hl-lhi-po-purpose role=purpose -->
## What HL.LHI.PO does

`HL.LHI.PO` is a standalone `48`-bit scalar AGU instruction that loads one 2-byte little-endian value and sign-extends the transferred bits when the result is narrower than `PTO_XLEN` using `Immediate` addressing.

<!-- PTO-READER-BLOCK: scalar-hl-lhi-po-mechanism role=mechanism -->
...
<!-- PTO-READER-BLOCK: scalar-hl-lhi-po-inputs role=inputs-outputs -->
...
<!-- PTO-READER-BLOCK: scalar-hl-lhi-po-effects role=effects -->
...
After all result or writeback publication, `HL.LHI.PO` advances `TPC` by `6` bytes; a rejected or faulting attempt does not retire.

<!-- PTO-READER-BLOCK: scalar-hl-lhi-po-constraints role=constraints -->
...
<!-- PTO-READER-BLOCK: scalar-hl-lhi-po-example role=example -->
## Non-normative reading walkthrough

This walkthrough explains how to use the page and does not add instruction behavior.

- Start with the canonical assembly `hl.lhi.po [SrcL, simm], ->Dst0, Dst1` and identify the encoded address fields.
...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| hl_lhi_po_48_aa393747abda | RegDst0 | 5 | 0–31 | none | none | Reg5 first loaded-value destination or discard | Encoded zero discards this result without suppressing the instruction's other effects. |
| hl_lhi_po_48_aa393747abda | RegDst1 | 5 | 0–31 | none | none | Reg5 updated-base destination or discard | Encoded zero discards this result without suppressing the instruction's other effects. |
| hl_lhi_po_48_aa393747abda | SrcL | 5 | 0–31 | none | none | Reg5 address-base source | Encoded zero reads the architectural zero GPR. |
| hl_lhi_po_48_aa393747abda | simm17 | 17 | 0–131071 | none | none | signed address displacement | Encoded zero supplies a zero displacement; it does not denote omission. |

...
<!-- SUPPLEMENTARY-BEGIN -->
<!-- PTO-READER-BLOCK: scalar-hl-ldi-upo-purpose role=purpose -->
## What HL.LDI.UPO does

`HL.LDI.UPO` is a standalone `48`-bit scalar AGU instruction that loads one 8-byte little-endian value and zero-extends the transferred bits when the result is narrower than `PTO_XLEN` using `Immediate` addressing.

<!-- PTO-READER-BLOCK: scalar-hl-ldi-upo-mechanism role=mechanism -->
...
<!-- PTO-READER-BLOCK: scalar-hl-ldi-upo-inputs role=inputs-outputs -->
...
<!-- PTO-READER-BLOCK: scalar-hl-ldi-upo-effects role=effects -->
...
After all result or writeback publication, `HL.LDI.UPO` advances `TPC` by `6` bytes; a rejected or faulting attempt does not retire.

<!-- PTO-READER-BLOCK: scalar-hl-ldi-upo-constraints role=constraints -->
...
<!-- PTO-READER-BLOCK: scalar-hl-ldi-upo-example role=example -->
## Non-normative reading walkthrough

This walkthrough explains how to use the page and does not add instruction behavior.

- Start with the canonical assembly `hl.ldi.upo [SrcL, simm], ->Dst0, Dst1` and identify the encoded address fields.
...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| hl_ldi_upo_48_5126b735cfe8 | RegDst0 | 5 | 0–31 | none | none | Reg5 first loaded-value destination or discard | Encoded zero discards this result without suppressing the instruction's other effects. |
| hl_ldi_upo_48_5126b735cfe8 | RegDst1 | 5 | 0–31 | none | none | Reg5 updated-base destination or discard | Encoded zero discards this result without suppressing the instruction's other effects. |
| hl_ldi_upo_48_5126b735cfe8 | SrcL | 5 | 0–31 | none | none | Reg5 address-base source | Encoded zero reads the architectural zero GPR. |
| hl_ldi_upo_48_5126b735cfe8 | simm17 | 17 | 0–131071 | none | none | signed address displacement | Encoded zero supplies a zero displacement; it does not denote omission. |

...
<!-- SUPPLEMENTARY-BEGIN -->
<!-- PTO-READER-BLOCK: scalar-hl-sd-upr-purpose role=purpose -->
## What HL.SD.UPR does

`HL.SD.UPR` is a standalone `48`-bit AGU instruction that forms a register-offset address and stores one aligned little-endian `8`-byte value.

<!-- PTO-READER-BLOCK: scalar-hl-sd-upr-mechanism role=mechanism -->
## Address and memory mechanism

`HL.SD.UPR` transforms `SrcR` according to `SrcRType` and adds the unscaled result modulo `2^PTO_XLEN` to the snapshotted `SrcL` base.
...
<!-- PTO-READER-BLOCK: scalar-hl-sd-upr-inputs role=inputs-outputs -->
## Inputs and outputs
...
<!-- PTO-READER-BLOCK: scalar-hl-sd-upr-effects role=effects -->
...
<!-- PTO-READER-BLOCK: scalar-hl-sd-upr-constraints role=constraints -->
...
<!-- PTO-READER-BLOCK: scalar-hl-sd-upr-example role=example -->
...
| --- | --- | ---: | --- | --- |
| hl_sd_upr_48_af7118270a90 | HL48 | 48 | 0x00007049002e / 0x00007fff07ff | [{"field":"SrcRType","operator":"one-of","values":[0,1,2]}] |
...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| hl_sd_upr_48_af7118270a90 | RegDst | 5 | 0–31 | none | none | Reg5 updated-base destination or discard | Encoded zero discards this result without suppressing the instruction's other effects. |
| hl_sd_upr_48_af7118270a90 | SrcD | 5 | 0–31 | none | none | Reg5 first store-data source | Encoded zero reads the architectural zero GPR. |
| hl_sd_upr_48_af7118270a90 | SrcL | 5 | 0–31 | none | none | Reg5 address-base source | Encoded zero reads the architectural zero GPR. |
| hl_sd_upr_48_af7118270a90 | SrcR | 5 | 0–31 | none | none | Reg5 register-offset source | Encoded zero reads the architectural zero GPR. |
| hl_sd_upr_48_af7118270a90 | SrcRType | 2 | 0–2 | none | 3 | register-offset transformation selector | Encoded zero leaves the complete PTO_XLEN register-offset value unchanged. |

- `hl_sd_upr_48_af7118270a90.SrcRType` reserved values: Reserved encodings raise Fault_IllegalInstruction before architectural effects.

...
<!-- SUPPLEMENTARY-BEGIN -->
<!-- PTO-READER-BLOCK: scalar-hl-lhuip-purpose role=purpose -->
## What HL.LHUIP does

`HL.LHUIP` is a standalone `48`-bit scalar AGU instruction that loads two adjacent 2-byte little-endian values and zero-extends each transferred value when it is narrower than `PTO_XLEN` using `Immediate` addressing.

<!-- PTO-READER-BLOCK: scalar-hl-lhuip-mechanism role=mechanism -->
...
<!-- PTO-READER-BLOCK: scalar-hl-lhuip-inputs role=inputs-outputs -->
...
<!-- PTO-READER-BLOCK: scalar-hl-lhuip-effects role=effects -->
...
After all result or writeback publication, `HL.LHUIP` advances `TPC` by `6` bytes; a rejected or faulting attempt does not retire.

<!-- PTO-READER-BLOCK: scalar-hl-lhuip-constraints role=constraints -->
...
<!-- PTO-READER-BLOCK: scalar-hl-lhuip-example role=example -->
## Non-normative reading walkthrough

This walkthrough explains how to use the page and does not add instruction behavior.

- Start with the canonical assembly `hl.lhuip [SrcL, simm], ->Dst0, Dst1` and identify the encoded address fields.
...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| hl_lhuip_48_0b0ef5bd2405 | RegDst0 | 5 | 0–31 | none | none | Reg5 first loaded-value destination or discard | Encoded zero discards this result without suppressing the instruction's other effects. |
| hl_lhuip_48_0b0ef5bd2405 | RegDst1 | 5 | 0–31 | none | none | Reg5 second loaded-value destination or discard | Encoded zero discards this result without suppressing the instruction's other effects. |
| hl_lhuip_48_0b0ef5bd2405 | SrcL | 5 | 0–31 | none | none | Reg5 address-base source | Encoded zero reads the architectural zero GPR. |
| hl_lhuip_48_0b0ef5bd2405 | simm17 | 17 | 0–131071 | none | none | signed address displacement | Encoded zero supplies a zero displacement; it does not denote omission. |

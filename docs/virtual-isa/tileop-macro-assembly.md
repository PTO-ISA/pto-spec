...
- `Row` resolution: Row has no independent physical encoding and uses the selected form's resolution record: a sized destination is statically checked from its TSize, Col, and element type; source-only forms require source descriptor state; an unrecoverable Row prevents stateless folding.
...
| TileOp | Engine | Canonical macro format |
| --- | --- | --- |
| `TMATMUL` | `CUBE` | `TMATMUL <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, SrcTile0, SrcTile1, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL.SHARED_RIGHT <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, LocalLeftGroup, SharedRightGroup, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL.SHARED_BOTH <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, SharedLeftGroup, SharedRightGroup, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |
| `TMATMUL_ACC` | `CUBE` | `TMATMUL_ACC <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, AccTile, SrcTile0, SrcTile1, CScaleTile{if CScaleEn}, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL_ACC.SHARED_RIGHT <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, AccTile, LocalLeftGroup, SharedRightGroup, CScaleTile{if CScaleEn}, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL_ACC.SHARED_BOTH <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, AccTile, SharedLeftGroup, SharedRightGroup, CScaleTile{if CScaleEn}, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |
| `TMATMUL_BIAS` | `CUBE` | `TMATMUL_BIAS <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, SrcTile0, SrcTile1, BiasTile, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL_BIAS.SHARED_RIGHT <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, LocalLeftGroup, SharedRightGroup, BiasTile, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL_BIAS.SHARED_BOTH <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, SharedLeftGroup, SharedRightGroup, BiasTile, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |
| `TMATMUL_MX` | `CUBE` | `TMATMUL_MX <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, SrcTile0, RowScaleTile{if AType requires MX scale}, SrcTile1, ColumnScaleTile{if BType requires MX scale}, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL_MX.SHARED_RIGHT <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, LocalLeftGroup, SharedRightGroup, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL_MX.SHARED_BOTH <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, SharedLeftGroup, SharedRightGroup, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |
| `TMATMUL_MX_ACC` | `CUBE` | `TMATMUL_MX_ACC <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, AccTile, SrcTile0, RowScaleTile{if AType requires MX scale}, SrcTile1, ColumnScaleTile{if BType requires MX scale}, CScaleTile{if CScaleEn}, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL_MX_ACC.SHARED_RIGHT <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, AccTile, LocalLeftGroup, SharedRightGroup, CScaleTile{if CScaleEn}, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL_MX_ACC.SHARED_BOTH <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, AccTile, SharedLeftGroup, SharedRightGroup, CScaleTile{if CScaleEn}, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |
| `TMATMUL_MX_BIAS` | `CUBE` | `TMATMUL_MX_BIAS <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, SrcTile0, RowScaleTile{if AType requires MX scale}, SrcTile1, ColumnScaleTile{if BType requires MX scale}, BiasTile, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL_MX_BIAS.SHARED_RIGHT <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, LocalLeftGroup, SharedRightGroup, BiasTile, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}`<br>`TMATMUL_MX_BIAS.SHARED_BOTH <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE{must be AllPE}>, SharedLeftGroup, SharedRightGroup, BiasTile, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |

### matrix-and-matrix-vector/matrix-vector

| TileOp | Engine | Canonical macro format |
| --- | --- | --- |
| `TGEMV` | `CUBE` | `TGEMV <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, SrcVector, SrcMatrix, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |
| `TGEMV_ACC` | `CUBE` | `TGEMV_ACC <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, AccTile, SrcVector, SrcMatrix, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |
| `TGEMV_BIAS` | `CUBE` | `TGEMV_BIAS <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, SrcVector, SrcMatrix, BiasTile, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |
| `TGEMV_MX` | `CUBE` | `TGEMV_MX <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, SrcVector, RowScaleTile{if AType requires MX scale}, SrcMatrix, ColumnScaleTile{if BType requires MX scale}, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |
| `TGEMV_MX_ACC` | `CUBE` | `TGEMV_MX_ACC <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, AccTile, SrcVector, RowScaleTile{if AType requires MX scale}, SrcMatrix, ColumnScaleTile{if BType requires MX scale}, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |
| `TGEMV_MX_BIAS` | `CUBE` | `TGEMV_MX_BIAS <M=1, N=1, K=1, AType, BType?, RMode?, Sat?, FPAttrs, PEMask=AllPE>, SrcVector, RowScaleTile{if AType requires MX scale}, SrcMatrix, ColumnScaleTile{if BType requires MX scale}, BiasTile, RowMaxIn{if RowMaxEn&&RowMaxInit}, QuantParamTile{if PreQuantMode=vector}, ReluParamTile{if ReluMode=vector}, QuantParamGPR{if PreQuantMode=scalar}, ReluParamGPR{if ReluMode=scalar}, ->DstTile<Size>, ->RowMaxOut<Size>{if RowMaxEn}, ->GroupMaxOut<Size>{if GroupMaxEn}` |

<!-- GENERATED FROM: asl/tile/reduction/row-reduction/TROWMIN.asl -->
# TROWMIN

**Normative ASL source:** `asl/tile/reduction/row-reduction/TROWMIN.asl`

Reduce each source row to its minimum.

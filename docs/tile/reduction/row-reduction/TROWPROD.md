<!-- GENERATED FROM: asl/tile/reduction/row-reduction/TROWPROD.asl -->
# TROWPROD

**Normative ASL source:** `asl/tile/reduction/row-reduction/TROWPROD.asl`

Reduce each source row to its product.

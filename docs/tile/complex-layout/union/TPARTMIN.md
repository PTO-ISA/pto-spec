<!-- GENERATED FROM: asl/tile/complex-layout/union/TPARTMIN.asl -->
# TPARTMIN
...
<!-- GENERATED-ASL-BEGIN: operation source=asl/tile/complex-layout/union/TPARTMIN.asl -->
```asl

<!-- GENERATED FROM: asl/tile/unary-tile-elementwise/logical/TRELU.asl -->
# TRELU

**Normative ASL source:** `asl/tile/unary-tile-elementwise/logical/TRELU.asl`

Apply elementwise rectified-linear activation to the source Tile.

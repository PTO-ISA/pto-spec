...
Form the origin-anchored union of two Local Tiles and select the minimum of overlap elements.
...
<!-- SUPPLEMENTARY-BEGIN -->
<!-- PTO-READER-BLOCK: tile-tpartmin-purpose role=purpose -->
## Purpose

`TPARTMIN` forms an origin-anchored union and selects overlap minima.

<!-- PTO-READER-BLOCK: tile-tpartmin-mechanism role=mechanism -->
## Execution mechanism
...
<!-- PTO-READER-BLOCK: tile-tpartmin-inputs-outputs role=inputs-outputs -->
...
<!-- PTO-READER-BLOCK: tile-tpartmin-effects role=effects -->
...
<!-- PTO-READER-BLOCK: tile-tpartmin-constraints role=constraints -->
...
<!-- PTO-READER-BLOCK: tile-tpartmin-example role=example -->
...
Read `BSTART.SFU TPARTMIN, S16; B.DIM LB0=16; B.IOT Left, Right, mask=1111, <last>, ->Dst<1>; BSTOP` as a non-normative binding walkthrough, then use the generated contract below for exact dimensions, attributes, and fault behavior.
<!-- SUPPLEMENTARY-END -->
...
- TPARTMIN uses the TEPL encoding carrier Mode 3 Function 20, canonically assembles with BSTART.SFU, and has no standalone opcode.
...
- At an overlap coordinate, typed minimum selection is applied with the common DataType's exact arithmetic, ordering, rounding, NaN, signed-zero, and status behavior.
...
- BSTART.SFU TPARTMIN, S16; B.DIM LB0=16; B.IOT Left, Right, mask=1111, <last>, ->Dst<1>; BSTOP

<!-- GENERATED FROM: asl/tile/tile-scalar-elementwise/logical/TORS.asl -->
# TORS

**Normative ASL source:** `asl/tile/tile-scalar-elementwise/logical/TORS.asl`

Apply elementwise bitwise OR between the source Tile and bound scalar.

<!-- GENERATED FROM: asl/tile/model/dispatch/tile-scalar-elementwise.asl -->
# Tile Scalar Elementwise

**Normative ASL source:** `asl/tile/model/dispatch/tile-scalar-elementwise.asl`

This page is a generated reference view of the normative ASL unit.

## ASL unit identity {#PTO-TILE-MODEL-DISPATCH-TILE-SCALAR-ELEMENTWISE}

## Normative ASL

<!-- GENERATED-ASL-BEGIN: unit source=asl/tile/model/dispatch/tile-scalar-elementwise.asl -->
```asl

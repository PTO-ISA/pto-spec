<!-- GENERATED FROM: asl/tile/reduce-and-expand/row-expansion/TROWEXPANDMIN.asl -->
# TROWEXPANDMIN
...
<!-- SUPPLEMENTARY-BEGIN -->
<!-- PTO-READER-BLOCK: tile-c-trowexpandmin-purpose role=purpose -->
## What TROWEXPANDMIN does

`TROWEXPANDMIN` takes minimum with a one-column broadcast across each valid row.

<!-- PTO-READER-BLOCK: tile-c-trowexpandmin-mechanism role=mechanism -->
## Operation mechanism
...
<!-- PTO-READER-BLOCK: tile-c-trowexpandmin-inputs-outputs role=inputs-outputs -->
...
<!-- PTO-READER-BLOCK: tile-c-trowexpandmin-effects role=effects -->
...
<!-- PTO-READER-BLOCK: tile-c-trowexpandmin-constraints role=constraints -->
...
<!-- PTO-READER-BLOCK: tile-c-trowexpandmin-example role=example -->
## Non-normative example

This example illustrates the current ASL-bound contract and is not a second instruction definition.

`TROWEXPANDMIN <bundle operands>` performs complete preflight and source snapshotting before atomically publishing the mnemonic-defined result and padding state.
<!-- SUPPLEMENTARY-END -->
...
<!-- GENERATED-ASL-BEGIN: decode source=asl/tile/reduce-and-expand/row-expansion/TROWEXPANDMIN.asl -->
```asl
...
<!-- GENERATED-ASL-BEGIN: operation source=asl/tile/reduce-and-expand/row-expansion/TROWEXPANDMIN.asl -->
```asl
...
- BSTART.SFU TROWEXPANDMIN, DataType; B.DATR Layout, PadValue (optional); B.DIM LB0=ValidCol; B.DIM LB1=ValidRow (optional); B.DIM LB2=Col (optional); B.IOT SrcTile, BroadcastTile, mask=PE_MASK, <last>, ->DstTile<TSize>; BSTOP

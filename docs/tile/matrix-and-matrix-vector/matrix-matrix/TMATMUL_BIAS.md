...
<!-- SUPPLEMENTARY-BEGIN -->
<!-- PTO-READER-BLOCK: tile-tmatmul-bias-purpose role=purpose -->
## Purpose

`TMATMUL_BIAS` multiplies matrices and adds the Bias Tile.

<!-- PTO-READER-BLOCK: tile-tmatmul-bias-mechanism role=mechanism -->
## Execution mechanism

The ASL DOC contract selects `TileHandler_TMATMUL_BIAS` through the instruction's selector-encoded block carrier.
...
<!-- PTO-READER-BLOCK: tile-tmatmul-bias-inputs-outputs role=inputs-outputs -->
## Operands and descriptors

`destination0` is the destination; `source0` is the left; `source1` is the right; `source2` is the bias.
...
<!-- PTO-READER-BLOCK: tile-tmatmul-bias-effects role=effects -->
...
<!-- PTO-READER-BLOCK: tile-tmatmul-bias-constraints role=constraints -->
...
<!-- PTO-READER-BLOCK: tile-tmatmul-bias-example role=example -->

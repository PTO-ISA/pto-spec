...
| Stage 6 | Open | The generated S6-T1 ledger closes exact traceability inventory/link coverage across 924 units. The generated S6-T2 ledger closes the ten-gate contract, hosted workflow policy, and exact 34-shard/110-call/104-subprogram topology. | S5-T2 leaves 11 requirements and 28 hooks open; no immutable candidate, complete local/hosted results, protected-branch snapshot, or architecture/formal approvals exist. |
...
operations, 72 system registers, 13 traps, 36 profile hooks, and 74 top-level
ASL state roots. Composite roots expand to 229 leaf fields so nested bundle,
...
proves 34 shards partition 110 canonical calls reaching 104 test subprograms.
...
| `S6-T2-B` | Closed | Hosted and parallel execution contract | Full action pins, least-privilege workflow, required `validate`, 360-minute bound, and exact 34/110/104 partition pass fail-closed checks. |

<!-- GENERATED FROM: asl/arch/data-types/formats/e1m2x2.asl -->
# E1m2x2

**Normative ASL source:** `asl/arch/data-types/formats/e1m2x2.asl`

This page is a generated reference view of the normative ASL unit.

## ASL unit identity {#PTO-ARCH-DATA-TYPES-FORMAT-E1M2X2}
...
<!-- SUPPLEMENTARY-BEGIN -->
<!-- PTO-READER-BLOCK: arch-format-e1m2x2-purpose role=purpose-scope -->
## Purpose and scope

E1M2X2 is an assigned PTO numeric format. This page helps a reader connect its carrier layout, finite-value decomposition, and value classification; the exact contract remains in `E1M2X2NumericFormatDescriptor`, `E1M2X2FiniteDecomposition`, and `ClassifyE1M2X2` in the ASL owner.

<!-- PTO-READER-BLOCK: arch-format-e1m2x2-concepts role=concepts-state -->
## Carrier and fields
...
<!-- PTO-READER-BLOCK: arch-format-e1m2x2-rules role=rules-interactions -->
## Decomposition and classification

`E1M2X2FiniteDecomposition` reports whether a finite decomposition is available and, when available, returns the sign, an integer significand, and a binary exponent. `ClassifyE1M2X2` separately assigns the raw lane to zero, subnormal, normal, infinity, or NaN classes supported by this format.
...
<!-- PTO-READER-BLOCK: arch-format-e1m2x2-boundaries role=boundaries -->
...
<!-- PTO-READER-BLOCK: arch-format-e1m2x2-example role=example-usage -->
...
<!-- PTO-READER-BLOCK: arch-format-e1m2x2-related role=related-owners-navigation -->
## Related owners
...
<!-- GENERATED-ASL-BEGIN: unit source=asl/arch/data-types/formats/e1m2x2.asl -->
```asl

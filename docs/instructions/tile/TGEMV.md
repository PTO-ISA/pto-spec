...
- PTO 来源页：[`../pto/TGEMV.md`](../pto/TGEMV.md)
- DavinciOO target public name：`TGEMV`
...
RecordEvent TGEMV(TileDst &d, TileA &a, TileB &b, PostProcessOperands<PP> &...ppOperands, WaitEvents &...events);
```
...
```asm
TGEMV <LB0:M, LB1:N, LB2:K, AType, BType, PostProcess>, A, B, [RowMaxIn], [QuantParam], [ReLUParam], ->D, [->RowMaxOut], [->GroupMaxOut]
```
...
| Header | 本指令用途 | 公共定义 |
| --- | --- | --- |
| `BSTART.CUBE` | 选择 `TGEMV` 与 AType | [`header/BSTART.CUBE.md`](../bundle/BSTART.CUBE.md) |

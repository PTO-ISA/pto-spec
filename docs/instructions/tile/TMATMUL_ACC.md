...
{
  "schema_version": 1,
  "id": "intrinsic.tmatmul_acc",
  "kind": "intrinsic",
  "title": "TMATMUL_ACC 内建函数",
  "status": "mapped",
  "visibility": "public",
  "profile": "pto-isa-0.58.0",
  "sources": {
    "davincioo": "TMATMUL_ACC.md",
    "pto": "tile/ops/matrix-and-matrix-vector/tmatmul-acc.md"
  },
  "opcode": "TMATMUL_ACC",
  "family": "matrix-cube",
...
- PTO 来源页：[`../pto/TMATMUL_ACC.md`](../pto/TMATMUL_ACC.md)
- DavinciOO target public name：`TMATMUL_ACC`
...
RecordEvent TMATMUL_ACC(TileDst &d, TileAccIn &c, TileA &a, TileB &b, PostProcessOperands<PP> &...ppOperands, WaitEvents &...events);
```
...
```asm
TMATMUL.ACC <LB0:M, LB1:N, LB2:K, AType, BType, PostProcess>, C, A, B, [RowMaxIn], [QuantParam], [ReLUParam], ->D, [->RowMaxOut], [->GroupMaxOut]
```
...
| Header | 本指令用途 | 公共定义 |
| --- | --- | --- |
| `BSTART.CUBE` | 选择 `TMATMUL.ACC` 与 AType | [`header/BSTART.CUBE.md`](../bundle/BSTART.CUBE.md) |

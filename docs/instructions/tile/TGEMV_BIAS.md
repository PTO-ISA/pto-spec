...
{
  "schema_version": 1,
  "id": "intrinsic.tgemv_bias",
  "kind": "intrinsic",
  "title": "TGEMV_BIAS 内建函数",
  "status": "mapped",
  "visibility": "public",
  "profile": "pto-isa-0.58.0",
  "sources": {
    "davincioo": "TGEMV_BIAS.md",
    "pto": "tile/ops/matrix-and-matrix-vector/tgemv-bias.md"
  },
  "opcode": "TGEMV_BIAS",
  "family": "matrix-cube",
  "bundle": "BSTART.CUBE TGEMV.BIAS AType\nB.DATR BType RMode Sat\nB.FPATR\nB.DIM LB0 M\nB.DIM LB1 N\nB.DIM LB2 K\nB.IOT Local sources and Local outputs\nB.IOR scalar PostProcess parameter (optional)",
  "operands": {
...
- PTO 来源页：[`../pto/TGEMV_BIAS.md`](../pto/TGEMV_BIAS.md)
- DavinciOO target public name：`TGEMV_BIAS`
...
RecordEvent TGEMV_BIAS(TileDst &d, TileA &a, TileB &b, TileBias &bias, PostProcessOperands<PP> &...ppOperands, WaitEvents &...events);
```
...
```asm
TGEMV.BIAS <LB0:M, LB1:N, LB2:K, AType, BType, PostProcess>, A, B, Bias, [RowMaxIn], [QuantParam], [ReLUParam], ->D, [->RowMaxOut], [->GroupMaxOut]
```
...
| Header | 本指令用途 | 公共定义 |
| --- | --- | --- |
| `BSTART.CUBE` | 选择 `TGEMV.BIAS` 与 AType | [`header/BSTART.CUBE.md`](../bundle/BSTART.CUBE.md) |

...
> 状态：DavinciOO v5 superscalar 指令页。本文只描述 `TCVT` 的 PTO 语义、DavinciOO block intrinsic 展开与合法性；公共 header 的 opcode/bitfield 编码见 [`header/`](../bundle/overview/block-header-model.md)。
...
| Header | 本指令用途 | 公共定义 |
| --- | --- | --- |
| `BSTART.TEPL` | 选择 `TCVT` opcode profile 与 `SrcType` | [`header/BSTART.TEPL.md`](../bundle/BSTART.TEPL.md) |
| `B.DATR` | 必需；描述 `DstType/RMode/Sat`，并可同时描述 `PadValue` 等 data attribute | [`header/B.DATR.md`](../bundle/B.DATR.md) |

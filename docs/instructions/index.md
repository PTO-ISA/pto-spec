...
TEPL is an encoding carrier, not an execution engine.

## Tile execution engines

| Engine | Operations | Role |
| --- | --- | --- |
| VEC | 35 | Element-wise Tile operations. |
| SFU | 52 | Complex transcendental, reduction, rearrangement, and irregular operations. |
| TLSU | 10 | Tile memory and data movement. |

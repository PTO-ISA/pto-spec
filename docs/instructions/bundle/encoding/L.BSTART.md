---
{
  ...
  "sources": {
    "davincioo": "header/L.BSTART.md"
  }
}
---
# L.BSTART

64位长度的L.BSTART指令在支持[超长指令扩展](../../instset/longInstrs.md)的处理器中允许使用，相比标准版本的[BSTART](../lifecycle/BSTART.md)以及增强版本的[HL.BSTART](./HL.BSTART.md)提供更大范围的跳转距离，因此可用于更长距离的跳转场景。

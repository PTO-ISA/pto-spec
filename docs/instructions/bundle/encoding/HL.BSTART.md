---
{
  ...
  "sources": {
    "davincioo": "header/HL.BSTART.md"
  }
}
---
# HL.BSTART

48位长度的HL.BSTART指令在支持增强指令扩展的处理器中允许使用，这条指令相比标准版本的[BSTART](../lifecycle/BSTART.md)提供更大范围的跳转距离，因此可用于更长距离的跳转场景。

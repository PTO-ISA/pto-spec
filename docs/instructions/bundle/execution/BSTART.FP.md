---
{
  ...
  "sources": {
    "davincioo": "header/BSTART.FP.md"
  }
}
---
# BSTART.FP

This page groups the `FP` execution-class selector across all published BSTART encoding lengths and their applicable `BrType` forms.
...
浮点块块头通过`BSTART.FP`作为起始指令，其他块头指令根据需要进行补充。例如，如果指定块热度等信息，可以增加[B.HINT](../lifecycle/B.HINT.md)指令等。

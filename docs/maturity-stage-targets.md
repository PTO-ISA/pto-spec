...
| `S6-T2-B` — execution topology | Closed | Prove the hosted workflow and parallel suite are bounded and exact. | Full action pins, contents-read permission, required `validate` aggregator, cancel-in-progress, 360-minute timeout, and 51 shards covering 113 calls/107 subprograms. |

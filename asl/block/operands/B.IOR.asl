...
// Row-mode MGATHER/MSCATTER consumers MUST bind RegSrc0 as the GM base and
// RegSrc1 as a nonzero GM row stride in elements and MUST reject a stride
// smaller than ValidCol before effects. Elem mode and MGATHER.CAS MUST consume
// only RegSrc0 and MUST require RegSrc1 to encode zero. RegSrc2 and RegDst MUST
// encode zero for every indexed TLSU form.

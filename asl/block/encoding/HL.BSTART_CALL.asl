// PTO-INSTRUCTION: {"assembly":["HL.BSTART.CALL <br_label>, <rt_label>, ->ra"],"block":[],"catalog_indices":[74],"catalog_records":[{"asm":"HL.BSTART.CALL <br_label>, <rt_label>, ->ra","constraints":[],"encoding":[{"index":0,"mask":"0xf83f0000007f","match":"0x501600000011","width_bits":48}],"encoding_kind":"HL48","fields":[{"name":"simm25","pieces":[{"instruction_lsb":7,"value_lsb":0,"width":25}],"signedness":"signed","width":25},{"name":"uimm5","pieces":[{"instruction_lsb":38,"value_lsb":0,"width":5}],"signedness":"unsigned","width":5}],"form_id":"hl_bstart_call_48_3c784c583c90","length_bits":48,"mnemonic":"HL.BSTART CALL","semantic_family":"BBD","semantic_group":"BSTART","semantic_handler":"ExecuteBundleStart","semantic_summary":"Atomically closes the current bundle, computes the call target from the signed displacement and the return address from the independent unsigned displacement, writes ra, and transfers control to the call bundle.","status":"accepted"}],"classification":["encoding"],"mnemonic":"HL.BSTART CALL","summary":"Atomically closes the current bundle, computes the call target from the signed displacement and the return address from the independent unsigned displacement, writes ra, and transfers control to the call bundle.","surface":"block","id":"PTO-BLOCK-HL-BSTART-CALL","depends_on":["PTO-BLOCK-MODEL-SCHEMA-PROFILE-ENCODING"]}
// DOC-BEGIN: decode

...
// control only the corresponding Shared primary; bits 10:9 and every other
// reserved mode value MUST
...
// corresponding Shared A or B primary, while bits 10:9 MUST remain zero.
// Local-side transpose MUST reject before source snapshots or output effects.

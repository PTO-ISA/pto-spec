...
// DataType MUST be checked independently. Exact backing and operation-type
// identity is legal; a cross-type backing MUST be non-four-bit and equal-width
// compatible. Omitted

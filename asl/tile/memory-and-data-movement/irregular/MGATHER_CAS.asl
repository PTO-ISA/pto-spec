...
// S32 or U32 byte-displacement indices and preserve raw carrier
// bits without numeric-validity rejection. Each valid lane MUST perform one
// atomic compare-and-swap at BaseGPR plus the signed or unsigned byte
// displacement supplied by IndexTile and MUST place

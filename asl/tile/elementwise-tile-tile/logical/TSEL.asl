...
// destination DataType; each source backing DataType MUST remain distinct,
// non-four-bit, same-width, and compatible with that type. RowMajor and CUBE

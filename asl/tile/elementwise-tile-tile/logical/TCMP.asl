...
// each source backing DataType MUST be a distinct, non-four-bit, same-width
// carrier compatible with that operation type. RowMajor sources MUST retain

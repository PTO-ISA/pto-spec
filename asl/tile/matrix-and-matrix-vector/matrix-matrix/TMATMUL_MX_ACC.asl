...
// Shared A MUST have exact physical valid shape [group_M,K] for TransA=0 or
// [K,group_M] for TransA=1; Shared B MUST have exact physical valid shape
// [N,K] for TransB=0 or [K,N] for TransB=1; physical columns MAY be padded
// only within legal descriptor capacity.

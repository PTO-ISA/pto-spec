...
// class. Bias uses the resolved M layout ML (CUBE_M16 or CUBE_M32), matching D and Local A when present; it is one Local logical 1xN accumulator-type source (FP32 for MX). Published

...
// For CUBE_M16/M32, destination physical Rows MUST equal source physical Rows and destination physical Columns MUST align ValidColumns using destination DataType.
// NDF-END: PTO-TCOLMAX-CONTRACT-001
// DOC-BEGIN: decode

...
type TileInfo of record {
    ...
    // CUBE descriptors retain storage-aligned geometry independently from
    // the current valid region.  Ordinary tiles mirror rows/columns here.
    storage_rows: integer {0..65535},
    storage_columns: integer {0..65535},
    storage_bytes: integer {0..262144},

// PTO-INSTRUCTION: {"assembly":["xoriw SrcL, simm, ->{t, u, Rd}"],"block":[],"catalog_indices":[472],"catalog_records":[{"asm":"xoriw SrcL, simm, ->{t, u, Rd}","constraints":[],"encoding":[{"index":0,"mask":"0x0000707f","match":"0x00004035","width_bits":32}],"encoding_kind":"L32","fields":[{"name":"RegDst","pieces":[{"instruction_lsb":7,"value_lsb":0,"width":5}],"signedness":"encoding-defined","width":5},{"name":"SrcL","pieces":[{"instruction_lsb":15,"value_lsb":0,"width":5}],"signedness":"encoding-defined","width":5},{"name":"simm12","pieces":[{"instruction_lsb":20,"value_lsb":0,"width":12}],"signedness":"signed","width":12}],"form_id":"xoriw_32_1f8c6f43e2bd","length_bits":32,"mnemonic":"XORIW","semantic_family":"ALU","semantic_group":"ALU","semantic_handler":"ScalarBinaryW","status":"accepted","semantic_summary":"XORIW - Compute this mnemonic's 32-bit binary operation and sign-extend the result."}],"classification":["alu"],"mnemonic":"XORIW","summary":"XORIW - Compute this mnemonic's 32-bit binary operation and sign-extend the result.","surface":"scalar","id":"PTO-SCALAR-XORIW","depends_on":["PTO-BLOCK-MODEL-SCHEMA-PROFILE-ENCODING"]}
// DOC-BEGIN: decode

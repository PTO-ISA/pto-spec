// PTO-INSTRUCTION: {"assembly":["c.zext.h srcL, ->t"],"block":[],"catalog_indices":[56],"catalog_records":[{"asm":"c.zext.h srcL, ->t","constraints":[],"encoding":[{"index":0,"mask":"0xf83f","match":"0x601c","width_bits":16}],"encoding_kind":"C16","fields":[{"name":"SrcL","pieces":[{"instruction_lsb":6,"value_lsb":0,"width":5}],"signedness":"encoding-defined","width":5}],"form_id":"c_zext_h_16_4c0976791cbc","length_bits":16,"mnemonic":"C.ZEXT.H","semantic_family":"ALU","semantic_group":"ALU","semantic_handler":"ExtendScalarValue","status":"accepted","semantic_summary":"C.ZEXT.H - Sign-extend or zero-extend the selected scalar subword."}],"classification":["alu"],"mnemonic":"C.ZEXT.H","summary":"C.ZEXT.H - Sign-extend or zero-extend the selected scalar subword.","surface":"scalar","id":"PTO-SCALAR-C-ZEXT-H","depends_on":["PTO-BLOCK-MODEL-SCHEMA-PROFILE-ENCODING"]}
// DOC-BEGIN: decode

// PTO-INSTRUCTION: {"assembly":["fmin.{T} SrcL, SrcR, ->{t, u, Rd}"],"block":[],"catalog_indices":[115],"catalog_records":[{"asm":"fmin.{T} SrcL, SrcR, ->{t, u, Rd}","constraints":[],"encoding":[{"index":0,"mask":"0xf800707f","match":"0x0000705b","width_bits":32}],"encoding_kind":"L32","fields":[{"name":"RegDst","pieces":[{"instruction_lsb":7,"value_lsb":0,"width":5}],"signedness":"encoding-defined","width":5},{"name":"SrcL","pieces":[{"instruction_lsb":15,"value_lsb":0,"width":5}],"signedness":"encoding-defined","width":5},{"name":"SrcR","pieces":[{"instruction_lsb":20,"value_lsb":0,"width":5}],"signedness":"encoding-defined","width":5},{"name":"SrcType","pieces":[{"instruction_lsb":25,"value_lsb":0,"width":2}],"signedness":"encoding-defined","width":2}],"form_id":"fmin_32_b5c106e5cd7e","length_bits":32,"mnemonic":"FMIN","semantic_family":"FSU","semantic_group":"FSU","semantic_handler":"FloatingBinary","status":"accepted","semantic_summary":"FMIN - Compute this mnemonic's binary floating-point operation."}],"classification":["fsu"],"mnemonic":"FMIN","summary":"FMIN - Compute this mnemonic's binary floating-point operation.","surface":"scalar","id":"PTO-SCALAR-FMIN","depends_on":["PTO-BLOCK-MODEL-SCHEMA-PROFILE-ENCODING"]}
// DOC-BEGIN: decode

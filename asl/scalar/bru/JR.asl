// PTO-INSTRUCTION: {"assembly":["jr SrcL, label"],"block":[],"catalog_indices":[315],"catalog_records":[{"asm":"jr SrcL, label","constraints":[],"encoding":[{"index":0,"mask":"0x0000707f","match":"0x00006027","width_bits":32}],"encoding_kind":"L32","fields":[{"name":"SrcL","pieces":[{"instruction_lsb":15,"value_lsb":0,"width":5}],"signedness":"encoding-defined","width":5},{"name":"SrcZero","pieces":[{"instruction_lsb":20,"value_lsb":0,"width":5}],"signedness":"encoding-defined","width":5},{"name":"simm12","pieces":[{"instruction_lsb":25,"value_lsb":0,"width":7},{"instruction_lsb":7,"value_lsb":7,"width":5}],"signedness":"signed","width":12}],"form_id":"jr_32_c4128e843b05","length_bits":32,"mnemonic":"JR","semantic_family":"BRU","semantic_group":"BRU","semantic_handler":"JumpRegister","status":"accepted","semantic_summary":"JR - Jump to the scalar-register target."}],"classification":["bru"],"mnemonic":"JR","summary":"JR - Jump to the scalar-register target.","surface":"scalar","id":"PTO-SCALAR-JR","depends_on":["PTO-BLOCK-MODEL-SCHEMA-PROFILE-ENCODING"]}
// DOC-BEGIN: decode

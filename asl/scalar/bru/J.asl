// PTO-INSTRUCTION: {"assembly":["j label"],"block":[],"catalog_indices":[306],"catalog_records":[{"asm":"j label","constraints":[],"encoding":[{"index":0,"mask":"0x0000707f","match":"0x00000037","width_bits":32}],"encoding_kind":"L32","fields":[{"name":"simm22","pieces":[{"instruction_lsb":15,"value_lsb":0,"width":17},{"instruction_lsb":7,"value_lsb":17,"width":5}],"signedness":"signed","width":22}],"form_id":"j_32_a303cf05af42","length_bits":32,"mnemonic":"J","semantic_family":"BRU","semantic_group":"BRU","semantic_handler":"JumpRelative","semantic_summary":"J - Jump to the PC-relative target.","status":"accepted"}],"classification":["bru"],"contract":{"block_composition":["none"],"canonical_assembly":["j label"],"defaults":["The selected assembly form determines which fields are present; every present field carries its encoded value and no encoded zero means omission."],"encoding_class":"standalone-encoded","examples":["j label"],"exceptions":["Reserved field encodings raise Fault_IllegalInstruction before effects; handler-specific arithmetic, memory, control-flow, system-register, and privilege faults follow the embedded normative ASL operation."],"field_contracts":{},"field_zero_meanings":{"simm22":"Encoded zero supplies numeric zero for the 22-bit signed immediate or displacement."},"legality":["Every value in each unconstrained encoded field is assigned; constrained complements are reserved and reject before effects."],"memory_effects":["none"],"operands":[{"field":"simm22","role":"22-bit signed immediate or displacement"}],"ordering":["none"],"standalone_opcode":true,"state_effects":["J - Jump to the PC-relative target.","After decode and legality checks, execute the normative JumpRelative ASL handler; no other architectural state is modified."]},"depends_on":["PTO-BLOCK-MODEL-SCHEMA-PROFILE-ENCODING"],"id":"PTO-SCALAR-J","mnemonic":"J","summary":"J - Jump to the PC-relative target.","surface":"scalar"}
// PTO-REVIEW: {"review_method":"formal-definition-read","outcome":"FORMAL-COMPLETE","reviewed_fields":["assembly","encoding","defaults","operation","state","memory","ordering","faults","reserved"]}
// NDF-BEGIN: PTO-J-DECISION-BINDING-001
...
// NDF-END: PTO-J-DECISION-BINDING-001
// DOC-BEGIN: decode

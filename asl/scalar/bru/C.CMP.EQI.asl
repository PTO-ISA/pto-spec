// PTO-INSTRUCTION: {"assembly":["c.cmp.eqi t#1, simm, ->t"],"block":[],"catalog_indices":[34],"catalog_records":[{"asm":"c.cmp.eqi t#1, simm, ->t","constraints":[],"encoding":[{"index":0,"mask":"0xf83f","match":"0x002c","width_bits":16}],"encoding_kind":"C16","fields":[{"name":"simm5","pieces":[{"instruction_lsb":6,"value_lsb":0,"width":5}],"signedness":"signed","width":5}],"form_id":"c_cmp_eqi_16_e34367883ba1","length_bits":16,"mnemonic":"C.CMP.EQI","semantic_family":"BRU","semantic_group":"BRU","semantic_handler":"ExecuteCompare","status":"accepted","semantic_summary":"C.CMP.EQI - Compare scalar operands and write the encoded boolean result."}],"classification":["bru"],"mnemonic":"C.CMP.EQI","summary":"C.CMP.EQI - Compare scalar operands and write the encoded boolean result.","surface":"scalar","id":"PTO-SCALAR-C-CMP-EQI","depends_on":["PTO-BLOCK-MODEL-SCHEMA-PROFILE-ENCODING"]}
// DOC-BEGIN: decode

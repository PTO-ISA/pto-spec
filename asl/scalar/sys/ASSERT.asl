// PTO-INSTRUCTION: {"assembly":["assert SrcL"],"block":[],"catalog_indices":[11],"catalog_records":[{"asm":"assert SrcL","constraints":[],"encoding":[{"index":0,"mask":"0xfff07fff","match":"0x0000102b","width_bits":32}],"encoding_kind":"L32","fields":[{"name":"SrcL","pieces":[{"instruction_lsb":15,"value_lsb":0,"width":5}],"signedness":"encoding-defined","width":5}],"form_id":"assert_32_f05d67874ae5","length_bits":32,"mnemonic":"ASSERT","semantic_family":"SYS","semantic_group":"SYS","semantic_handler":"ArchitectureAssert","status":"accepted","semantic_summary":"ASSERT - Raise the architecture assertion trap when its condition fails."}],"classification":["sys"],"mnemonic":"ASSERT","summary":"ASSERT - Raise the architecture assertion trap when its condition fails.","surface":"scalar","id":"PTO-SCALAR-ASSERT","depends_on":["PTO-BLOCK-MODEL-SCHEMA-PROFILE-ENCODING"]}
// DOC-BEGIN: decode

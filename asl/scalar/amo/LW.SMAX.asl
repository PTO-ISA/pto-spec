...
// DOC-END: decode
// DOC-BEGIN: operation
readonly func InstructionContractHandler_LW_SMAX()
    => ScalarSemanticHandler
begin
    return ScalarHandler_AtomicReadModifyWrite;
end;

pure func InstructionContractAtomicOperation_LW_SMAX()
    => AtomicOperation
begin
    return Atomic_SMAX;
end;

pure func InstructionContractAtomicSizeBytes_LW_SMAX()
    => integer {1,2,4,8}
begin
    return 4;
end;

pure func InstructionContractPublishesOldValue_LW_SMAX()
    => boolean
begin
    return TRUE;
end;

pure func InstructionContractSignExtendsOldValue_LW_SMAX()
    => boolean
begin
    return TRUE;
end;

...
Release traceability covers 831 ASL units, 831 generated pages, 3250
independently runnable AVS points, and 635 executable mnemonic requirements.
...
- A named `pto-hardware-numeric-0.58.2-ieee-v1` contract. B.FPATR matrix
  post-processing is bit-exact in ASL; independent implementation conformance
  for the remaining numeric domains remains open under `S5-T2`.

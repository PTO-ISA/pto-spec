// PTO-TEST: {"id":"PTO-AVS-BLOCK-B-DATR-LAYOUT-MAP-001","source":"asl/block/attributes/B.DATR.asl","requirements":["PTO-INST-BLOCK-B-DATR"],"kind":"boundary","summary":"The nineteen assigned Layout encodings have exact bidirectional mappings.","pass_condition":"Every assigned sparse code maps to its named transformation and round-trips; every other code is reserved.","related_sources":["asl/block/model/state/control-state.asl"]}
func main() => integer
begin

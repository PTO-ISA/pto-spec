// PTO-TEST: {"id":"PTO-AVS-BLOCK-B-FPATR-RSVD-001","source":"asl/block/attributes/B.FPATR.asl","requirements":["PTO-INST-BLOCK-B-FPATR"],"kind":"fault","summary":"reserved PreQuantMode codes 6 through 11 reject before B.FPATR state","pass_condition":"each code raises Fault_IllegalInstruction without descriptor or TPC changes","related_sources":["asl/block/model/dispatch/decode.asl"]}
func main() => integer
begin
    for code = 6 to 11 do
        ResetProfileState();

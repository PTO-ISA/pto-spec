...
// PTO-TEST: {"id":"PTO-AVS-BLOCK-TESTBUNDLETILECOMMITLIFECYCLE-STATE-TRANSITION-001","source":"asl/block/model/commit/effects.asl","requirements":[],"kind":"state-transition","summary":"migrated independent behavior point for TestBundleTileCommitLifecycle","pass_condition":"TestBundleTileCommitLifecycle completes without assertion failure","related_sources":[]}

...
// PTO-TEST: {"id":"PTO-AVS-BLOCK-TESTBUNDLETILEALLOCATIONANDLIFETIME-EXECUTION-001","source":"asl/block/model/lifecycle/lifetime.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestBundleTileAllocationAndLifetime","pass_condition":"TestBundleTileAllocationAndLifetime completes without assertion failure","related_sources":[]}

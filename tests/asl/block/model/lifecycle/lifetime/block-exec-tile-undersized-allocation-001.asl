...
// PTO-TEST: {"id":"PTO-AVS-BLOCK-TESTBUNDLETILEUNDERSIZEDALLOCATION-EXECUTION-001","source":"asl/block/model/lifecycle/lifetime.asl","requirements":[],"kind":"execution","summary":"Covers Bundle Tile Undersized Allocation.","pass_condition":"TestBundleTileUndersizedAllocation completes without assertion failure","related_sources":[]}

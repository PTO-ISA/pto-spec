...
// PTO-TEST: {"id":"PTO-AVS-BLOCK-TESTBUNDLESTATELIFECYCLE-STATE-TRANSITION-001","source":"asl/block/model/lifecycle/begin.asl","requirements":[],"kind":"state-transition","summary":"Covers Bundle State Lifecycle.","pass_condition":"TestBundleStateLifecycle completes without assertion failure","related_sources":[]}

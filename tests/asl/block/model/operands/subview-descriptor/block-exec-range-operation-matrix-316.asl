...
begin
    ...
    let started = ExecuteCommandInstruction(Zeros{64} + 0x21d19181, 32);
    ...
    assert BundleOperationBindingsComplete(117);
    let prepared_stage2 = PrepareSelectedBundleStage2();
    assert prepared_stage2;
    assert SelectedBundleClosedSchemasLegal(117);

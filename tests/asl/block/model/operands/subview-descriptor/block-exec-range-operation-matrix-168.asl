...
// Generated by scripts/generate-bundle-operation-matrix.py; case: RANGE-MATRIX-CASE-0168
// RANGE-MATRIX-CASE-0168 TCI destination0 -> case_0168_normal_commit
...
begin
    ...
    let datr = ExecuteCommandInstruction(Zeros{64} + 0x01101023, 32);

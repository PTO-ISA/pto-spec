...
// Generated by scripts/generate-bundle-operation-matrix.py; case: RANGE-MATRIX-CASE-0235
// RANGE-MATRIX-CASE-0235 TGEMV_ACC destination0 -> case_0235_normal_commit
...
begin
    ...
    assert BundleOperationBindingsComplete(90);
    let prepared_stage2 = PrepareSelectedBundleStage2();
    assert prepared_stage2;
    assert SelectedBundleClosedSchemasLegal(90);

...
// Generated by scripts/generate-bundle-operation-matrix.py; case: RANGE-MATRIX-CASE-0245
// RANGE-MATRIX-CASE-0245 TMATMUL_MX_ACC source3 -> case_0245_normal_commit
...
begin
    ...
    assert BundleOperationBindingsComplete(96);
    let prepared_stage2 = PrepareSelectedBundleStage2();
    assert prepared_stage2;
    assert SelectedBundleClosedSchemasLegal(96);

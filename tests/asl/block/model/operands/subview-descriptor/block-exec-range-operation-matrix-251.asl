...
// Generated by scripts/generate-bundle-operation-matrix.py; case: RANGE-MATRIX-CASE-0251
// RANGE-MATRIX-CASE-0251 TGEMV_MX_ACC source4 -> case_0251_normal_commit
...
begin
    ...
    assert BundleOperationBindingsComplete(93);
    let prepared_stage2 = PrepareSelectedBundleStage2();
    assert prepared_stage2;
    assert SelectedBundleClosedSchemasLegal(93);

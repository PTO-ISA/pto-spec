...
// RANGE-MATRIX-CASE-0244 TGEMV_MX_BIAS source3 -> case_0244_normal_commit
...
begin
    ...
    assert BundleOperationBindingsComplete(92);
    let prepared_stage2 = PrepareSelectedBundleStage2();
    assert prepared_stage2;
    assert SelectedBundleClosedSchemasLegal(92);

...
// Generated by scripts/generate-bundle-operation-matrix.py; case: RANGE-MATRIX-CASE-0252
// RANGE-MATRIX-CASE-0252 TGEMV_MX_ACC source3 -> case_0252_normal_commit
...
begin
    ...
    assert BundleOperationBindingsComplete(94);
    let prepared_stage2 = PrepareSelectedBundleStage2();
    assert prepared_stage2;
    assert SelectedBundleClosedSchemasLegal(94);

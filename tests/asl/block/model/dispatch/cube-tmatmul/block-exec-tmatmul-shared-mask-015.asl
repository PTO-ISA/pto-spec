...
func PrepareMaskSharedOperand(index: TileIndex, shared_id: bits(8),
                              value: integer)
begin
...
begin
    for raw_mask = 1 to 15 do
        ...
        PrepareMaskSharedOperand(10, Zeros{8} + 50, 2);
        PrepareMaskSharedOperand(11, Zeros{8} + 51, 3);
        ...
        BindBundleSharedIO(Zeros{8} + 50, 0, mask);
        BindBundleSharedIO(Zeros{8} + 51, 0, mask);

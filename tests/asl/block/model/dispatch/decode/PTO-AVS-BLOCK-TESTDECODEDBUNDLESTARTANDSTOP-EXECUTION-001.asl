...
// PTO-TEST: {"id":"PTO-AVS-BLOCK-TESTDECODEDBUNDLESTARTANDSTOP-EXECUTION-001","source":"asl/block/model/dispatch/decode.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestDecodedBundleStartAndStop","pass_condition":"TestDecodedBundleStartAndStop completes without assertion failure","related_sources":[]}

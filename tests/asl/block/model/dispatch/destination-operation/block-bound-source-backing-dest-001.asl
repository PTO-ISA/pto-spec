// PTO-TEST: {"id":"PTO-AVS-BLOCK-SOURCE-BACKING-DEST-001","source":"asl/block/model/dispatch/destination-operation.asl","requirements":["PTO-TMOV-CONTRACT-001"],"kind":"boundary","summary":"Source-carrier layout operations allocate the destination with the source backing DataType","pass_condition":"TMOV selected with a U16 carrier over BF16-backed sources each allocate a BF16-backed destination and pass carrier-width legality","related_sources":["asl/tile/model/legality/dtype-layout.asl","asl/tile/model/legality/memory-schema.asl","asl/tile/model/legality/layout-rearrangement.asl"]}

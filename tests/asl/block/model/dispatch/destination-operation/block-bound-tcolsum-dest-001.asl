// PTO-TEST: {"id":"PTO-AVS-BLOCK-TCOLSUM-DEST-001","source":"asl/block/model/dispatch/destination-operation.asl","requirements":["PTO-TCOLSUM-CONTRACT-001"],"kind":"boundary","summary":"TCOLSUM allocates one valid destination row while preserving source column geometry.","pass_condition":"The renamed destination remains U64 with ValidRow one, source.ValidCol valid columns, and the source physical column count.","related_sources":["asl/block/model/dispatch/reduction-schema.asl","asl/tile/reduce-and-expand/column-reduction/TCOLSUM.asl"]}

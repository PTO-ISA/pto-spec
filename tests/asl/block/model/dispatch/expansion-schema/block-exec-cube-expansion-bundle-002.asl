// PTO-TEST: {"id":"PTO-AVS-BLOCK-CUBE-EXPANSION-BUNDLE-002","source":"asl/block/model/dispatch/expansion-schema.asl","requirements":["PTO-B-DATR-FIELDS-001","PTO-TROWEXPANDADD-CONTRACT-001"],"kind":"execution","summary":"A decoded direct-layout B.DATR drives CUBE expansion schema validation, destination allocation, execution, and mixed-layout rejection.","pass_condition":"a CUBE_M16 TROWEXPANDADD bundle allocates and publishes an M16 destination, while an M32 broadcast mismatch faults before destination allocation.","related_sources":["asl/block/model/dispatch/destination-shape.asl","asl/tile/model/legality/reduction-and-expansion.asl","asl/tile/model/execution/expansion.asl"]}

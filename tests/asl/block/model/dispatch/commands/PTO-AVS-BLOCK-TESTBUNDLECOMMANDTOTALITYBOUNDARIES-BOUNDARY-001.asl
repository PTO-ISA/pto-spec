...
// PTO-TEST: {"id":"PTO-AVS-BLOCK-TESTBUNDLECOMMANDTOTALITYBOUNDARIES-BOUNDARY-001","source":"asl/block/model/dispatch/commands.asl","requirements":[],"kind":"boundary","summary":"migrated independent behavior point for TestBundleCommandTotalityBoundaries","pass_condition":"TestBundleCommandTotalityBoundaries completes without assertion failure","related_sources":[]}

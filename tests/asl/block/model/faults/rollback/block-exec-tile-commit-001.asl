...
// PTO-TEST: {"id":"PTO-AVS-BLOCK-TESTBUNDLETILECOMMITROLLBACK-EXECUTION-001","source":"asl/block/model/faults/rollback.asl","requirements":[],"kind":"execution","summary":"Covers Bundle Tile Commit Rollback.","pass_condition":"TestBundleTileCommitRollback completes without assertion failure","related_sources":[]}

...
// PTO-TEST: {"id":"PTO-AVS-BLOCK-TESTBUNDLECONFIGURATIONSTATE-STATE-TRANSITION-001","source":"asl/block/model/state/control-state.asl","requirements":[],"kind":"state-transition","summary":"migrated independent behavior point for TestBundleConfigurationState","pass_condition":"TestBundleConfigurationState completes without assertion failure","related_sources":[]}

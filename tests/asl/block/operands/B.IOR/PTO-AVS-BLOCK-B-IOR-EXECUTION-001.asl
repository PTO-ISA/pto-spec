...
// PTO-TEST: {"id":"PTO-AVS-BLOCK-B-IOR-EXECUTION-001","source":"asl/block/operands/B.IOR.asl","requirements":["PTO-INST-BLOCK-B-IOR"],"kind":"execution","summary":"migrated independent behavior point for TestBundleScalarBindingSchemaDefaults","pass_condition":"TestBundleScalarBindingSchemaDefaults completes without assertion failure","related_sources":[]}

// PTO-TEST: {"id":"PTO-AVS-BLOCK-B-IOR-DEFAULTS-EXEC-001","source":"asl/block/operands/B.IOR.asl","requirements":["PTO-INST-BLOCK-B-IOR"],"kind":"execution","summary":"B.IOR schema defaults distinguish omission from encoded zero","pass_condition":"schema default and unused-field assertions hold","related_sources":[]}

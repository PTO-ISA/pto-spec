...
// PTO-TEST: {"id":"PTO-AVS-BLOCK-B-IOR-EXECUTION-001","source":"asl/block/operands/B.IOR.asl","requirements":["PTO-INST-BLOCK-B-IOR"],"kind":"execution","summary":"Covers ordered GPR helper coverage.","pass_condition":"TestBundleOrderedGPRControls completes without assertion failure","related_sources":[]}

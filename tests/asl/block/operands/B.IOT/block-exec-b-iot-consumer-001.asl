// PTO-TEST: {"id":"PTO-AVS-BLOCK-B-IOT-CONSUMER-001","source":"asl/block/operands/B.IOT.asl","requirements":["PTO-INST-BLOCK-B-IOT","PTO-INST-TILE-TLOAD"],"kind":"execution","summary":"A decoded B.IOT boundary SizeCode reaches the normal Local TLOAD consumer.","pass_condition":"A 64 KiB destination commits, while an oversized decoded shape faults before Local allocation.","related_sources":["asl/block/model/dispatch/shared-tlsu.asl","asl/tile/model/shape/valid-region.asl","asl/tile/model/state/descriptors.asl"]}
...
func PrepareBIOTConsumer(dim0: integer, dim2: integer)
begin
    let started = ExecuteCommandInstruction(
        BIOTConsumerStart(Zeros{5} + 25), 32);
...
begin
    ...
    ResetProfileState();
    PrepareBIOTConsumer(16385, 16385);

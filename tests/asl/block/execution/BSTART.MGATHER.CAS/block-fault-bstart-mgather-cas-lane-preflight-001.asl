// PTO-TEST: {"id":"PTO-AVS-BLOCK-MGATHER-CAS-FAULT-001","source":"asl/block/execution/BSTART.MGATHER.CAS.asl","requirements":["PTO-MGATHER-CAS-PUBLICATION-001","PTO-INST-TILE-MGATHER-CAS"],"kind":"fault","summary":"MGATHER.CAS preflights every read and write lane before atomic effects.","pass_condition":"A page fault on the second U16 lane rolls back destination allocation and leaves the first lane, memory, and atomic-event log unchanged.","related_sources":["asl/tile/model/memory/atomics.asl","asl/arch/memory-model/fault-precision.asl"]}

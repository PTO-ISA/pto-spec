// PTO-TEST: {"id":"PTO-AVS-BLOCK-MGATHER-U4-INDEX-003","source":"asl/block/execution/BSTART.MGATHER.asl","requirements":["PTO-MGATHER-BYTE-DISPLACEMENT-001"],"kind":"execution","summary":"MGATHER zero-extends a packed U4 IndexTile byte displacement.","pass_condition":"The low-nibble U4 value fifteen addresses base plus fifteen without transfer-type scaling.","related_sources":["asl/tile/model/memory/addressing.asl","asl/tile/model/definedness/elements.asl"]}

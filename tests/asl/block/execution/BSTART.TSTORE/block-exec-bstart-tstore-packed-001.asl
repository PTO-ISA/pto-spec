// PTO-TEST: {"id":"PTO-AVS-BLOCK-TSTORE-PACKED-001","source":"asl/block/execution/BSTART.TSTORE.asl","requirements":["PTO-INST-BLOCK-BSTART-TSTORE","PTO-INST-TILE-TSTORE"],"kind":"execution","summary":"Packed U4X2 TSTORE applies stride in logical elements before nibble selection.","pass_condition":"Two strided rows update the expected low and high nibbles without changing skipped bytes.","related_sources":["asl/tile/model/memory/addressing.asl","asl/tile/model/memory/load-store.asl"]}

// PTO-TEST: {"id":"PTO-AVS-BLOCK-TGEMVMX-BIAS-EXEC-001","source":"asl/block/execution/BSTART.TGEMVMX.BIAS.asl","requirements":["PTO-BSTART-TGEMVMX-BIAS-CONTRACT-001","PTO-INST-BLOCK-BSTART-TGEMVMX-BIAS"],"kind":"execution","summary":"TGEMVMX.BIAS adds one Local 1xN private-result Bias.","pass_condition":"A=2, B=3, and Bias=5 publish one Local FP32 destination containing 11.","related_sources":["asl/block/model/dispatch/cube-tmatmul.asl"]}
func main() => integer
begin
    ResetProfileState();
    ...
    var start: bits(64) = Zeros{64} + 0x01531181;

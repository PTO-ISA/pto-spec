// PTO-TEST: {"id":"PTO-AVS-BLOCK-TMATMUL-ACC-EXEC-001","source":"asl/block/execution/BSTART.TMATMUL.ACC.asl","requirements":["PTO-BSTART-TMATMUL-ACC-CONTRACT-001","PTO-INST-BLOCK-BSTART-TMATMUL-ACC"],"kind":"execution","summary":"TMATMUL.ACC adds an explicit Local accumulator after a 1x1 product.","pass_condition":"C=5, A=2, and B=3 publish one new FP32 destination containing 11.","related_sources":["asl/block/model/dispatch/cube-tmatmul.asl"]}
func main() => integer
begin
    ResetProfileState();

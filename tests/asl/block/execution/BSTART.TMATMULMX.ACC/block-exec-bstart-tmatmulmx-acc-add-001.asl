// PTO-TEST: {"id":"PTO-AVS-BLOCK-TMATMULMX-ACC-EXEC-001","source":"asl/block/execution/BSTART.TMATMULMX.ACC.asl","requirements":["PTO-BSTART-TMATMULMX-ACC-CONTRACT-001","PTO-INST-BLOCK-BSTART-TMATMULMX-ACC"],"kind":"execution","summary":"TMATMULMX.ACC adds an explicit Local accumulator.","pass_condition":"C=5, A=2, and B=3 publish one new FP32 destination containing 11.","related_sources":["asl/block/model/dispatch/cube-tmatmul.asl"]}
func main() => integer
begin
    ResetProfileState();
    ...
    var start: bits(64) = Zeros{64} + 0x00631181;

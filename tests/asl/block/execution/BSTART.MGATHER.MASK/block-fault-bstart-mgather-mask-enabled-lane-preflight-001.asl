...
begin
    ...
    ConfigurePredicateTile(1, 128, 3, 1, 3, 1);
    WriteTileElement(0, 0, 0, Zeros{PTO_XLEN} + 0x7fff);
    WriteTileElement(0, 0, 1, Ones{PTO_XLEN});
    WriteTileElement(0, 0, 2, Zeros{PTO_XLEN} + 1);
    WriteTilePredicateBit(1, 0, 0, FALSE);
    WriteTilePredicateBit(1, 1, 0, TRUE);
    WriteTilePredicateBit(1, 2, 0, TRUE);
    Store(Zeros{PTO_XLEN} + 4092, 2, Zeros{PTO_XLEN} + 11);

// PTO-TEST: {"id":"PTO-AVS-BLOCK-MSCATTER-SCATTER-001","source":"asl/block/execution/BSTART.MSCATTER.asl","requirements":["PTO-MSCATTER-BYTE-DISPLACEMENT-001","PTO-BSTART-MSCATTER-SCHEMA-001","PTO-INST-TILE-MSCATTER","PTO-INST-BLOCK-BSTART-MSCATTER"],"kind":"execution","summary":"MSCATTER writes only the valid region at full-width S64 byte displacements while preserving both sources.","pass_condition":"A 2x2 U8 source and S64 IndexTile with different physical column counts write four byte-displacement-derived addresses and leave both source descriptors unchanged.","related_sources":["asl/block/model/dispatch/tlsu-mscatter.asl","asl/tile/model/memory/gather-scatter.asl"]}

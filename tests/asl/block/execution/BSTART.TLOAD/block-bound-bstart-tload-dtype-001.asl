// PTO-TEST: {"id":"PTO-AVS-BLOCK-TLOAD-DTYPE-001","source":"asl/block/execution/BSTART.TLOAD.asl","requirements":["PTO-INST-BLOCK-BSTART-TLOAD","PTO-INST-TILE-TLOAD"],"kind":"boundary","summary":"BSTART.TLOAD accepts every assigned Tile DataType code.","pass_condition":"Codes 0..14, 16..20, and 24..28 execute while the seven reserved values reject before effects.","related_sources":["asl/arch/data-types/tile-data-types.asl"]}

...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARATOMICS-ATOMICITY-001","source":"asl/scalar/model/amo/semantics.asl","requirements":[],"kind":"atomicity","summary":"Covers Scalar Atomics.","pass_condition":"TestScalarAtomics completes without assertion failure","related_sources":[]}

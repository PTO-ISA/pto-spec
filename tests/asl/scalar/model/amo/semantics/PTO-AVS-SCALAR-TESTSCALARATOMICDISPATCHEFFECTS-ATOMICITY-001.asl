...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARATOMICDISPATCHEFFECTS-ATOMICITY-001","source":"asl/scalar/model/amo/semantics.asl","requirements":[],"kind":"atomicity","summary":"migrated independent behavior point for TestScalarAtomicDispatchEffects","pass_condition":"TestScalarAtomicDispatchEffects completes without assertion failure","related_sources":[]}

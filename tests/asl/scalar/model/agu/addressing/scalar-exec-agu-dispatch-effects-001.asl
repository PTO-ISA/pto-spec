...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARAGUDISPATCHEFFECTS-EXECUTION-001","source":"asl/scalar/model/agu/addressing.asl","requirements":[],"kind":"execution","summary":"Covers Scalar AGU Dispatch Effects.","pass_condition":"TestScalarAGUDispatchEffects completes without assertion failure","related_sources":[]}

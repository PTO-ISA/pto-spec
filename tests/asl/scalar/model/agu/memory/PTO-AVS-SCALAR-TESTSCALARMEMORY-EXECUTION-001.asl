...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARMEMORY-EXECUTION-001","source":"asl/scalar/model/agu/memory.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestScalarMemory","pass_condition":"TestScalarMemory completes without assertion failure","related_sources":[]}

// PTO-TEST: {"id":"PTO-AVS-ARCH-CONCRETE-ACCESS-EXEC-005","source":"asl/scalar/model/agu/memory.asl","requirements":[],"kind":"execution","summary":"reference-profile address, ACR, and trap access rules are exact","pass_condition":"address translation, access permission, and trap context assertions hold","related_sources":[]}

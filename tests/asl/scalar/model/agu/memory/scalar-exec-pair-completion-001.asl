...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARPAIRMEMORYCOMPLETION-EXECUTION-001","source":"asl/scalar/model/agu/memory.asl","requirements":[],"kind":"execution","summary":"Covers Scalar Pair Memory Completion.","pass_condition":"TestScalarPairMemoryCompletion completes without assertion failure","related_sources":[]}

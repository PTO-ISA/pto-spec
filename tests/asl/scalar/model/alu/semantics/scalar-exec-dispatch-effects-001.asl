...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARDISPATCHEFFECTS-EXECUTION-001","source":"asl/scalar/model/alu/semantics.asl","requirements":[],"kind":"execution","summary":"Covers Scalar Dispatch Effects.","pass_condition":"TestScalarDispatchEffects completes without assertion failure","related_sources":[]}

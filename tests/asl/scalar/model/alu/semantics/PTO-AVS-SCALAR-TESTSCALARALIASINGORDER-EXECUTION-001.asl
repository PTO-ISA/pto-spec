...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARALIASINGORDER-EXECUTION-001","source":"asl/scalar/model/alu/semantics.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestScalarAliasingOrder","pass_condition":"TestScalarAliasingOrder completes without assertion failure","related_sources":[]}

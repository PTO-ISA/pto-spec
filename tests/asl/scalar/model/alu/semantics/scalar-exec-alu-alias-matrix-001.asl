...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARALUALIASMATRIX-EXECUTION-001","source":"asl/scalar/model/alu/semantics.asl","requirements":[],"kind":"execution","summary":"Covers Scalar ALU Alias Matrix.","pass_condition":"TestScalarALUAliasMatrix completes without assertion failure","related_sources":[]}

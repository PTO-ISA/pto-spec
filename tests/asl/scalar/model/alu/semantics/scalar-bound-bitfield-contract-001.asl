...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARBITFIELDBOUNDARYCONTRACT-BOUNDARY-001","source":"asl/scalar/model/alu/semantics.asl","requirements":[],"kind":"boundary","summary":"Covers Scalar Bitfield Boundary Contract.","pass_condition":"TestScalarBitfieldBoundaryContract completes without assertion failure","related_sources":[]}

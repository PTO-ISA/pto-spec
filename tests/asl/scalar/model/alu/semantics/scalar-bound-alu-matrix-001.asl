...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARALUBOUNDARYMATRIX-BOUNDARY-001","source":"asl/scalar/model/alu/semantics.asl","requirements":[],"kind":"boundary","summary":"Covers Scalar ALU Boundary Matrix.","pass_condition":"TestScalarALUBoundaryMatrix completes without assertion failure","related_sources":[]}
...
begin
    ...
    assert _BARG.bpcn == zero;
    SetCommitTarget(ones);
    assert _BARG.bpcn == ones;

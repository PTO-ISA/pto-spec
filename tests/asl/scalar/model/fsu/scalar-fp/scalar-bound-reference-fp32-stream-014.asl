// PTO-TEST: {"id":"PTO-AVS-ARCH-REFERENCE-FP32-STREAM-014","source":"asl/scalar/model/fsu/scalar-fp.asl","requirements":[],"kind":"boundary","summary":"the exact compiler SCVTF FMADD FCVTZ stream preserves the 16.0 FP32 exponent boundary","pass_condition":"raw compiler encodings with the matching U and T queue positions publish FP32 160, FP32 16, and signed integer 16","related_sources":["asl/scalar/fsu/SCVTF.asl","asl/scalar/fsu/FMADD.asl","asl/scalar/fsu/FCVTZ.asl","asl/scalar/model/dispatch/fsu.asl"]}
func main() => integer
begin
    ResetProfileState();

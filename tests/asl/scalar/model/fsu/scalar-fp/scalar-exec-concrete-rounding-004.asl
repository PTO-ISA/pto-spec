// PTO-TEST: {"id":"PTO-AVS-ARCH-CONCRETE-ROUNDING-EXEC-004","source":"asl/scalar/model/fsu/scalar-fp.asl","requirements":[],"kind":"execution","summary":"reference-profile rounding and conversion operations are exact","pass_condition":"rounding selectors, scalar FP, and Tile conversion assertions hold","related_sources":[]}

// PTO-TEST: {"id":"PTO-AVS-ARCH-REFERENCE-FP32-POWER-013","source":"asl/scalar/model/fsu/scalar-fp.asl","requirements":[],"kind":"boundary","summary":"the finite FP32 reference profile preserves the 16.0 exponent boundary used by compiler-generated scalar initialization","pass_condition":"signed 160 converts to FP32, fused multiplication by the compiler 0.1 carrier rounds to 16.0, and RTZ converts the result back to signed 16","related_sources":["asl/scalar/model/fsu/reference-quantization.asl","asl/scalar/model/fsu/arithmetic.asl","asl/scalar/fsu/SCVTF.asl","asl/scalar/fsu/FMADD.asl","asl/scalar/fsu/FCVTZ.asl"]}
func main() => integer
begin

// PTO-TEST: {"id":"PTO-AVS-ARCH-CONCRETE-SUBNORMAL-EXEC-001","source":"asl/scalar/model/fsu/scalar-fp.asl","requirements":[],"kind":"execution","summary":"reference-profile subnormal boundaries and applicability are exact","pass_condition":"subnormal configuration, boundary, and applicability assertions hold","related_sources":[]}

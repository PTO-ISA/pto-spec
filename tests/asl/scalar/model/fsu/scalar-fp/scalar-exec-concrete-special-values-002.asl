// PTO-TEST: {"id":"PTO-AVS-ARCH-CONCRETE-SPECIAL-VALUES-EXEC-002","source":"asl/scalar/model/fsu/scalar-fp.asl","requirements":[],"kind":"execution","summary":"reference-profile NaN and signed-zero rules are exact","pass_condition":"NaN, comparison, min-max, and signed-zero assertions hold","related_sources":[]}

...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARFPDISPATCHEFFECTS-EXECUTION-001","source":"asl/scalar/model/fsu/arithmetic.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestScalarFPDispatchEffects","pass_condition":"TestScalarFPDispatchEffects completes without assertion failure","related_sources":[]}

...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARFLOATING-EXECUTION-001","source":"asl/scalar/model/fsu/arithmetic.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestScalarFloating","pass_condition":"TestScalarFloating completes without assertion failure","related_sources":[]}

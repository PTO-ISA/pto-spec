...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARFPFLAGLIFECYCLE-STATE-TRANSITION-001","source":"asl/scalar/model/fsu/arithmetic.asl","requirements":[],"kind":"state-transition","summary":"Covers Scalar FP Flag Lifecycle.","pass_condition":"TestScalarFPFlagLifecycle completes without assertion failure","related_sources":[]}

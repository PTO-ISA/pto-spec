// PTO-TEST: {"id":"PTO-AVS-ARCH-CONCRETE-VALUE-CLASSES-EXEC-003","source":"asl/scalar/model/fsu/reference-quantization.asl","requirements":[],"kind":"execution","summary":"reference-profile numeric encodings map to exact value classes","pass_condition":"encoding validity, value class, and canonical NaN assertions hold","related_sources":[]}

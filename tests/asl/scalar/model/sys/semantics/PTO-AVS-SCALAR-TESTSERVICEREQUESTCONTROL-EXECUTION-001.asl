...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSERVICEREQUESTCONTROL-EXECUTION-001","source":"asl/scalar/model/sys/semantics.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestServiceRequestControl","pass_condition":"TestServiceRequestControl completes without assertion failure","related_sources":[]}

...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARSYSTEMDISPATCHEFFECTS-EXECUTION-001","source":"asl/scalar/model/sys/semantics.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestScalarSystemDispatchEffects","pass_condition":"TestScalarSystemDispatchEffects completes without assertion failure","related_sources":[]}

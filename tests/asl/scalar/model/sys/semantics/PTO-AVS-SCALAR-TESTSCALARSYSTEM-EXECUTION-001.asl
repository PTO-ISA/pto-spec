...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-TESTSCALARSYSTEM-EXECUTION-001","source":"asl/scalar/model/sys/semantics.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestScalarSystem","pass_condition":"TestScalarSystem completes without assertion failure","related_sources":[]}

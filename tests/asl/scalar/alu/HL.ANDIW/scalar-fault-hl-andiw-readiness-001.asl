// PTO-TEST: {"id":"PTO-AVS-SCALAR-HL-ANDIW-READINESS-001","source":"asl/scalar/alu/HL.ANDIW.asl","requirements":["PTO-INST-SCALAR-HL-ANDIW"],"kind":"fault","summary":"HL.ANDIW rejects an unavailable relative source before effects","pass_condition":"unavailable T#4 preserves destination and TPC while reporting IllegalInstruction","related_sources":["asl/scalar/model/types/operands.asl"]}
func main() => integer
begin
    ResetProfileState();

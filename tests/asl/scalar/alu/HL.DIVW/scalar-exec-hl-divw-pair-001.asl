...
begin
    ...
    WriteGPR(1, dividend);
    WriteGPR(2, divisor);
    var instruction: bits(48) = Zeros{48} + 0x00002057000e;
    ...
    assert InstructionContractQuotient_HL_DIVW(dividend, divisor) == Zeros{PTO_XLEN} - 2;
    assert InstructionContractRemainder_HL_DIVW(dividend, divisor) == Ones{PTO_XLEN};
    return 0;
end;

// PTO-TEST: {"id":"PTO-AVS-SCALAR-HL-REMU-PAIR-001","source":"asl/scalar/alu/HL.REMU.asl","requirements":["PTO-INST-SCALAR-HL-REMU"],"kind":"execution","summary":"HL.REMU publishes quotient then remainder from source snapshots","pass_condition":"Decoded pair results match the mnemonic quotient and remainder contracts in destination order","related_sources":["asl/scalar/model/alu/semantics.asl"]}
func main() => integer
begin
    ResetProfileState();

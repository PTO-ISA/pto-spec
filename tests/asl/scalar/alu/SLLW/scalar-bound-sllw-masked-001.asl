// PTO-TEST: {"id":"PTO-AVS-SCALAR-SLLW-MASKED-001","source":"asl/scalar/alu/SLLW.asl","requirements":["PTO-INST-SCALAR-SLLW"],"kind":"boundary","summary":"SLLW masks the register count and snapshots T and U sources before U publication","pass_condition":"masked count, non-consuming sources, queue alias order, and mnemonic contract match SLLW","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/alu.asl"]}
func main() => integer
begin
    ResetProfileState();
    ...
    assert InstructionContractShiftAmount_SLLW(Zeros{PTO_XLEN} + 32) == 0;

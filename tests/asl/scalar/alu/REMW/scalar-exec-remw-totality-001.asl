...
begin
    ...
    WriteGPR(1, dividend);
    WriteGPR(2, divisor);
    var instruction: bits(48) = Zeros{48} + 0x00006057;
    ...
    assert InstructionContractResult_REMW(dividend, divisor) == Ones{PTO_XLEN};
    return 0;
end;

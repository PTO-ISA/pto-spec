// PTO-TEST: {"id":"PTO-AVS-SCALAR-MINU-ALIASES-001","source":"asl/scalar/alu/MINU.asl","requirements":["PTO-INST-SCALAR-MINU"],"kind":"boundary","summary":"MINU snapshots non-consuming T and U sources before publishing to U","pass_condition":"source queues persist, new U value uses old sources, and mnemonic contract matches MINU","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/alu.asl"]}
func main() => integer
begin
    ResetProfileState();

// PTO-TEST: {"id":"PTO-AVS-SCALAR-HL-CCAT-READINESS-001","source":"asl/scalar/alu/HL.CCAT.asl","requirements":["PTO-INST-SCALAR-HL-CCAT"],"kind":"fault","summary":"HL.CCAT rejects an unavailable source before either destination write","pass_condition":"unavailable T#4 preserves both destinations and TPC while reporting IllegalInstruction","related_sources":["asl/scalar/model/types/operands.asl"]}
func main() => integer
begin
    ResetProfileState();

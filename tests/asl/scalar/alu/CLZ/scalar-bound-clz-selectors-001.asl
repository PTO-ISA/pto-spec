// PTO-TEST: {"id":"PTO-AVS-SCALAR-CLZ-SELECTORS-001","source":"asl/scalar/alu/CLZ.asl","requirements":["PTO-INST-SCALAR-CLZ"],"kind":"boundary","summary":"CLZ assigns full-width zero, relative sources, queue destinations, and discard destinations","pass_condition":"T#1 zero returns 64 to T, U#1 one returns 63 to U, and destination code 24 discards without consuming either source queue","related_sources":["asl/scalar/model/types/operands.asl"]}
func main() => integer
begin
    ResetProfileState();
    ...
    var to_t: bits(48) = Zeros{48} + 0x00005067;
    ...
    assert ReadTemporaryQueue(FALSE, 0) == Zeros{PTO_XLEN} + 63;

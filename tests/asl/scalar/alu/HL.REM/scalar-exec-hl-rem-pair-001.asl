// PTO-TEST: {"id":"PTO-AVS-SCALAR-HL-REM-PAIR-001","source":"asl/scalar/alu/HL.REM.asl","requirements":["PTO-INST-SCALAR-HL-REM"],"kind":"execution","summary":"HL.REM publishes remainder then quotient from source snapshots","pass_condition":"Decoded pair results match the mnemonic remainder and quotient contracts in destination order","related_sources":["asl/scalar/model/alu/semantics.asl"]}
func main() => integer
begin
    ResetProfileState();

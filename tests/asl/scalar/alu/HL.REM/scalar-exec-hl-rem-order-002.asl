// PTO-TEST: {"id":"PTO-AVS-SCALAR-HL-REM-ORDER-002","source":"asl/scalar/alu/HL.REM.asl","requirements":["PTO-INST-SCALAR-HL-REM"],"kind":"execution","summary":"HL.REM duplicate destination retains the quotient","pass_condition":"RegDst0 and RegDst1 naming one GPR leaves the later quotient write visible","related_sources":["asl/scalar/model/alu/semantics.asl","asl/scalar/model/dispatch/alu.asl"]}
func main() => integer
begin
    ResetProfileState();

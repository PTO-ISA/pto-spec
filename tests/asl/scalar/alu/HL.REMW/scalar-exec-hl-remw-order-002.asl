// PTO-TEST: {"id":"PTO-AVS-SCALAR-HL-REMW-ORDER-002","source":"asl/scalar/alu/HL.REMW.asl","requirements":["PTO-INST-SCALAR-HL-REMW"],"kind":"execution","summary":"HL.REMW duplicate destination retains the quotient","pass_condition":"RegDst0 and RegDst1 naming one GPR leaves the later quotient write visible","related_sources":["asl/scalar/model/alu/semantics.asl","asl/scalar/model/dispatch/alu.asl"]}
func main() => integer
begin
    ResetProfileState();
    WriteGPR(1, Zeros{PTO_XLEN} + 0xfffffff9);

...
begin
    ...
    WriteGPR(1, left);
    WriteGPR(2, right);
    var instruction: bits(48) = Zeros{48} + 0x00002047;
    ...
    assert InstructionContractResult_MULW(left, right) == Zeros{PTO_XLEN} - 2;
    return 0;
end;

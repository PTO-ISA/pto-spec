// PTO-TEST: {"id":"PTO-AVS-SCALAR-HL-ADDIW-READINESS-001","source":"asl/scalar/alu/HL.ADDIW.asl","requirements":["PTO-INST-SCALAR-HL-ADDIW"],"kind":"fault","summary":"HL.ADDIW rejects an unavailable relative source before effects","pass_condition":"unavailable T#4 preserves destination and TPC while reporting IllegalInstruction","related_sources":["asl/scalar/model/types/operands.asl"]}
func main() => integer
begin
    ResetProfileState();

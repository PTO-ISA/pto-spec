// PTO-TEST: {"id":"PTO-AVS-SCALAR-SRLIW-ZERO-001","source":"asl/scalar/alu/SRLIW.asl","requirements":["PTO-INST-SCALAR-SRLIW"],"kind":"boundary","summary":"SRLIW shamt zero ignores source high bits and sign-extends the word","pass_condition":"identity word shift, U source preservation, and T publication match SRLIW","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/alu.asl"]}
func main() => integer
begin
    ResetProfileState();

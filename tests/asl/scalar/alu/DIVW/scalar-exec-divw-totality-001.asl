...
begin
    ...
    WriteGPR(1, dividend);
    WriteGPR(2, divisor);
    var instruction: bits(48) = Zeros{48} + 0x00002057;
    ...
    assert InstructionContractResult_DIVW(dividend, divisor) == Zeros{PTO_XLEN} - 2;
    return 0;
end;

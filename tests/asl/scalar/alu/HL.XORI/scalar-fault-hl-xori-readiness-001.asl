// PTO-TEST: {"id":"PTO-AVS-SCALAR-HL-XORI-READINESS-001","source":"asl/scalar/alu/HL.XORI.asl","requirements":["PTO-INST-SCALAR-HL-XORI"],"kind":"fault","summary":"HL.XORI rejects an unavailable relative source before effects","pass_condition":"unavailable T#4 preserves destination and TPC while reporting IllegalInstruction","related_sources":["asl/scalar/model/types/operands.asl"]}
func main() => integer
begin
    ResetProfileState();

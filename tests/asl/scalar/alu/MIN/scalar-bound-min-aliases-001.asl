// PTO-TEST: {"id":"PTO-AVS-SCALAR-MIN-ALIASES-001","source":"asl/scalar/alu/MIN.asl","requirements":["PTO-INST-SCALAR-MIN"],"kind":"boundary","summary":"MIN snapshots non-consuming T and U sources before publishing to U","pass_condition":"source queues persist, new U value uses old sources, and mnemonic contract matches MIN","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/alu.asl"]}
func main() => integer
begin
    ResetProfileState();

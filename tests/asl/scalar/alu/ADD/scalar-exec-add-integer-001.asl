...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-ADD-EXECUTION-001","source":"asl/scalar/alu/ADD.asl","requirements":["PTO-INST-SCALAR-ADD"],"kind":"execution","summary":"Covers Scalar Integer.","pass_condition":"TestScalarInteger completes without assertion failure","related_sources":[]}

...
begin
    ...
    assert InstructionContractAGUAddressKind_SHI() == ScalarAGU_Immediate;
    assert InstructionContractAGUSizeBytes_SHI() == 2;
    assert InstructionContractAGUOffsetScale_SHI() == 1;

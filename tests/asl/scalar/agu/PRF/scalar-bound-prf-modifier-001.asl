...
// PTO-TEST: {"id":"PTO-AVS-SCALAR-PRF-MODIFIER-001","source":"asl/scalar/agu/PRF.asl","requirements":["PTO-INST-SCALAR-PRF"],"kind":"boundary","summary":"PRF address formation interprets raw modifier codes as full-width, signed-word, unsigned-word, and negated full-width","pass_condition":"the address-specific modifier decoder matches ADR 0029 and PRD-169","related_sources":["asl/scalar/model/dispatch/decode.asl","asl/scalar/model/dispatch/agu.asl"]}

// PTO-TEST: {"id":"PTO-AVS-SCALAR-HL-CASB-PRECISE-001","source":"asl/scalar/amo/HL.CASB.asl","requirements":["PTO-INST-SCALAR-HL-CASB"],"kind":"fault","summary":"HL.CASB access fault is precise and preserves destination and reservation","pass_condition":"trap, memory, event, destination, reservation, recovery, and TPC match the HL.CASB contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckHL_CASBPreciseFault()
begin

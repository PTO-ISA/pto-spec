// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-UMAX-PRECISE-001","source":"asl/scalar/amo/SD.UMAX.asl","requirements":["PTO-INST-SCALAR-SD-UMAX"],"kind":"fault","summary":"SD.UMAX alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SD.UMAX contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSDUMAXPreciseAlignmentFault()
begin
    ...
    var instruction: bits(48) = Zeros{48} + 0x6000500b;
...
begin
    ResetProfileState();
    CheckSDUMAXPreciseAlignmentFault();
    return 0;
end;

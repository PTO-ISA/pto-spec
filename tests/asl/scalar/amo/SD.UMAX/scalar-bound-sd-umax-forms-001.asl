// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-UMAX-FORMS-001","source":"asl/scalar/amo/SD.UMAX.asl","requirements":["PTO-INST-SCALAR-SD-UMAX"],"kind":"boundary","summary":"SD.UMAX reads T and U relative sources with relaxed local defaults","pass_condition":"relative sources, default modifiers, memory, ordering, reservation, queues, and TPC match the SD.UMAX contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSDUMAXRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckSDUMAXRelativeDefaultForm();
    return 0;
end;

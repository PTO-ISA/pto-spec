// PTO-TEST: {"id":"PTO-AVS-SCALAR-HL-CASD-PRECISE-001","source":"asl/scalar/amo/HL.CASD.asl","requirements":["PTO-INST-SCALAR-HL-CASD"],"kind":"fault","summary":"HL.CASD access fault is precise and preserves destination and reservation","pass_condition":"trap, memory, event, destination, reservation, recovery, and TPC match the HL.CASD contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckHL_CASDPreciseFault()
begin
    ...
    WriteGPR(3, Zeros{PTO_XLEN} + 0x8000000000000001);

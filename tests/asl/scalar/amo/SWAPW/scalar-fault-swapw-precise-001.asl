// PTO-TEST: {"id":"PTO-AVS-SCALAR-SWAPW-PRECISE-001","source":"asl/scalar/amo/SWAPW.asl","requirements":["PTO-INST-SCALAR-SWAPW"],"kind":"fault","summary":"SWAPW access fault is precise and preserves prior state","pass_condition":"trap, memory, destination, event, reservation, and recovery match the SWAPW contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSWAPWPreciseFault()
begin

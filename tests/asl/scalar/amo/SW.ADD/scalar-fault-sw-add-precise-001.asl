// PTO-TEST: {"id":"PTO-AVS-SCALAR-SW-ADD-PRECISE-001","source":"asl/scalar/amo/SW.ADD.asl","requirements":["PTO-INST-SCALAR-SW-ADD"],"kind":"fault","summary":"SW.ADD alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SW.ADD contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSWADDPreciseAlignmentFault()
begin
    ...
    var instruction: bits(48) = Zeros{48} + 0x0000300b;
...
begin
    ResetProfileState();
    CheckSWADDPreciseAlignmentFault();
    return 0;
end;

// PTO-TEST: {"id":"PTO-AVS-SCALAR-SW-ADD-FORMS-001","source":"asl/scalar/amo/SW.ADD.asl","requirements":["PTO-INST-SCALAR-SW-ADD"],"kind":"boundary","summary":"SW.ADD reads T and U relative sources with relaxed local defaults","pass_condition":"relative sources, default modifiers, memory, ordering, reservation, queues, and TPC match the SW.ADD contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSWADDRelativeDefaultForm()
begin

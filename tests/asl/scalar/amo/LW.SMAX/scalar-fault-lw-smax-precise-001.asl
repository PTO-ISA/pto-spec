// PTO-TEST: {"id":"PTO-AVS-SCALAR-LW-SMAX-PRECISE-001","source":"asl/scalar/amo/LW.SMAX.asl","requirements":["PTO-INST-SCALAR-LW-SMAX"],"kind":"fault","summary":"LW.SMAX alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LW.SMAX contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLWSMAXPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLWSMAXPreciseAlignmentFault();
    return 0;
end;

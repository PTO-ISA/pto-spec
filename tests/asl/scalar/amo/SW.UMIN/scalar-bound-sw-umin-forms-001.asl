// PTO-TEST: {"id":"PTO-AVS-SCALAR-SW-UMIN-FORMS-001","source":"asl/scalar/amo/SW.UMIN.asl","requirements":["PTO-INST-SCALAR-SW-UMIN"],"kind":"boundary","summary":"SW.UMIN reads T and U relative sources with relaxed local defaults","pass_condition":"relative sources, default modifiers, memory, ordering, reservation, queues, and TPC match the SW.UMIN contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSWUMINRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckSWUMINRelativeDefaultForm();
    return 0;
end;

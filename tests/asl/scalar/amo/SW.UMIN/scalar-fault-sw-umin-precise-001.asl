// PTO-TEST: {"id":"PTO-AVS-SCALAR-SW-UMIN-PRECISE-001","source":"asl/scalar/amo/SW.UMIN.asl","requirements":["PTO-INST-SCALAR-SW-UMIN"],"kind":"fault","summary":"SW.UMIN alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SW.UMIN contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSWUMINPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckSWUMINPreciseAlignmentFault();
    return 0;
end;

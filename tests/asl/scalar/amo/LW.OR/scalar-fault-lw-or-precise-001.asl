// PTO-TEST: {"id":"PTO-AVS-SCALAR-LW-OR-PRECISE-001","source":"asl/scalar/amo/LW.OR.asl","requirements":["PTO-INST-SCALAR-LW-OR"],"kind":"fault","summary":"LW.OR alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LW.OR contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLWORPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLWORPreciseAlignmentFault();
    return 0;
end;

// PTO-TEST: {"id":"PTO-AVS-SCALAR-LW-OR-FORMS-001","source":"asl/scalar/amo/LW.OR.asl","requirements":["PTO-INST-SCALAR-LW-OR"],"kind":"boundary","summary":"LW.OR reads T and U sources and pushes its result to U with default modifiers","pass_condition":"relative sources, U push, relaxed ordering, nonoverlap reservation, and TPC match the LW.OR contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckLWORRelativeDefaultForm()
begin

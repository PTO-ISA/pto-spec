// PTO-TEST: {"id":"PTO-AVS-SCALAR-LW-ADD-PRECISE-001","source":"asl/scalar/amo/LW.ADD.asl","requirements":["PTO-INST-SCALAR-LW-ADD"],"kind":"fault","summary":"LW.ADD alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, destination, memory, event, reservation, queues, and recovery match the LW.ADD contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLWADDPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLWADDPreciseAlignmentFault();
    return 0;
end;

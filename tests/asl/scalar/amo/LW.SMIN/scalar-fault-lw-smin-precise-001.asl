// PTO-TEST: {"id":"PTO-AVS-SCALAR-LW-SMIN-PRECISE-001","source":"asl/scalar/amo/LW.SMIN.asl","requirements":["PTO-INST-SCALAR-LW-SMIN"],"kind":"fault","summary":"LW.SMIN alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LW.SMIN contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLWSMINPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLWSMINPreciseAlignmentFault();
    return 0;
end;

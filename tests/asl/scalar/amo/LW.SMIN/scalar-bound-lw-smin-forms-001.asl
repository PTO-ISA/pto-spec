// PTO-TEST: {"id":"PTO-AVS-SCALAR-LW-SMIN-FORMS-001","source":"asl/scalar/amo/LW.SMIN.asl","requirements":["PTO-INST-SCALAR-LW-SMIN"],"kind":"boundary","summary":"LW.SMIN reads T and U sources and pushes its result to U with default modifiers","pass_condition":"relative sources, U push, relaxed ordering, nonoverlap reservation, and TPC match the LW.SMIN contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckLWSMINRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckLWSMINRelativeDefaultForm();
    return 0;
end;

// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-OR-FORMS-001","source":"asl/scalar/amo/LD.OR.asl","requirements":["PTO-INST-SCALAR-LD-OR"],"kind":"boundary","summary":"LD.OR reads T and U sources and pushes its result to U with default modifiers","pass_condition":"relative sources, U push, relaxed ordering, nonoverlap reservation, and TPC match the LD.OR contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckLDORRelativeDefaultForm()
begin

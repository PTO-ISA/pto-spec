// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-OR-PRECISE-001","source":"asl/scalar/amo/LD.OR.asl","requirements":["PTO-INST-SCALAR-LD-OR"],"kind":"fault","summary":"LD.OR alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LD.OR contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLDORPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLDORPreciseAlignmentFault();
    return 0;
end;

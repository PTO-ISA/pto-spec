// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-UMAX-PRECISE-001","source":"asl/scalar/amo/LD.UMAX.asl","requirements":["PTO-INST-SCALAR-LD-UMAX"],"kind":"fault","summary":"LD.UMAX alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LD.UMAX contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLDUMAXPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLDUMAXPreciseAlignmentFault();
    return 0;
end;

// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-UMAX-FORMS-001","source":"asl/scalar/amo/LD.UMAX.asl","requirements":["PTO-INST-SCALAR-LD-UMAX"],"kind":"boundary","summary":"LD.UMAX reads T and U sources and pushes its result to U with default modifiers","pass_condition":"relative sources, U push, relaxed ordering, nonoverlap reservation, and TPC match the LD.UMAX contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckLDUMAXRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckLDUMAXRelativeDefaultForm();
    return 0;
end;

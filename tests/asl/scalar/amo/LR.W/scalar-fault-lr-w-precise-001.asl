// PTO-TEST: {"id":"PTO-AVS-SCALAR-LR-W-PRECISE-001","source":"asl/scalar/amo/LR.W.asl","requirements":["PTO-INST-SCALAR-LR-W"],"kind":"fault","summary":"LR.W access fault preserves the prior reservation and destination","pass_condition":"trap routing, destination, event, prior reservation, and recovery match the LR.W contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLRWPreciseFault()
begin

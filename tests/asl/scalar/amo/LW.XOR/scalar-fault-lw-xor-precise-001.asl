// PTO-TEST: {"id":"PTO-AVS-SCALAR-LW-XOR-PRECISE-001","source":"asl/scalar/amo/LW.XOR.asl","requirements":["PTO-INST-SCALAR-LW-XOR"],"kind":"fault","summary":"LW.XOR alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LW.XOR contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLWXORPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLWXORPreciseAlignmentFault();
    return 0;
end;

// PTO-TEST: {"id":"PTO-AVS-SCALAR-CASB-MISMATCH-001","source":"asl/scalar/amo/CASB.asl","requirements":["PTO-INST-SCALAR-CASB"],"kind":"boundary","summary":"CASB mismatch is an ordered atomic read with no write","pass_condition":"memory, U destination, mismatch event, reservation preservation, and TPC match the CASB contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckCASBMismatch()
begin

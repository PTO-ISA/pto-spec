// PTO-TEST: {"id":"PTO-AVS-SCALAR-SW-SMAX-PRECISE-001","source":"asl/scalar/amo/SW.SMAX.asl","requirements":["PTO-INST-SCALAR-SW-SMAX"],"kind":"fault","summary":"SW.SMAX alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SW.SMAX contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSWSMAXPreciseAlignmentFault()
begin
    ...
    var instruction: bits(48) = Zeros{48} + 0x4000300b;
...
begin
    ResetProfileState();
    CheckSWSMAXPreciseAlignmentFault();
    return 0;
end;

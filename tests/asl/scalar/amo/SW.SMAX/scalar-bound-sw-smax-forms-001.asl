// PTO-TEST: {"id":"PTO-AVS-SCALAR-SW-SMAX-FORMS-001","source":"asl/scalar/amo/SW.SMAX.asl","requirements":["PTO-INST-SCALAR-SW-SMAX"],"kind":"boundary","summary":"SW.SMAX reads T and U relative sources with relaxed local defaults","pass_condition":"relative sources, default modifiers, memory, ordering, reservation, queues, and TPC match the SW.SMAX contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSWSMAXRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckSWSMAXRelativeDefaultForm();
    return 0;
end;

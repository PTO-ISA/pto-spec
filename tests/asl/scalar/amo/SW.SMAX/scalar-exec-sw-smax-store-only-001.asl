...
begin
    ...
    assert InstructionContractAtomicOperation_SW_SMAX() == Atomic_SMAX;
    assert InstructionContractAtomicSizeBytes_SW_SMAX() == 4;
    assert !InstructionContractPublishesOldValue_SW_SMAX();
end;

func main() => integer
begin
    ResetProfileState();
    CheckSWSMAXStoreOnly();
    return 0;
end;

// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-SMIN-PRECISE-001","source":"asl/scalar/amo/SD.SMIN.asl","requirements":["PTO-INST-SCALAR-SD-SMIN"],"kind":"fault","summary":"SD.SMIN alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SD.SMIN contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSDSMINPreciseAlignmentFault()
begin
    ...
    var instruction: bits(48) = Zeros{48} + 0x5000500b;
...
begin
    ResetProfileState();
    CheckSDSMINPreciseAlignmentFault();
    return 0;
end;

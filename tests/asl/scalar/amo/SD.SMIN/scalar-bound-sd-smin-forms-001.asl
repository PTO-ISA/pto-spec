// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-SMIN-FORMS-001","source":"asl/scalar/amo/SD.SMIN.asl","requirements":["PTO-INST-SCALAR-SD-SMIN"],"kind":"boundary","summary":"SD.SMIN reads T and U relative sources with relaxed local defaults","pass_condition":"relative sources, default modifiers, memory, ordering, reservation, queues, and TPC match the SD.SMIN contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSDSMINRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckSDSMINRelativeDefaultForm();
    return 0;
end;

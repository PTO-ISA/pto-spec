// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-OR-PRECISE-001","source":"asl/scalar/amo/SD.OR.asl","requirements":["PTO-INST-SCALAR-SD-OR"],"kind":"fault","summary":"SD.OR alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SD.OR contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSDORPreciseAlignmentFault()
begin
    ...
    var instruction: bits(48) = Zeros{48} + 0x2000500b;
...
begin
    ResetProfileState();
    CheckSDORPreciseAlignmentFault();
    return 0;
end;

// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-OR-FORMS-001","source":"asl/scalar/amo/SD.OR.asl","requirements":["PTO-INST-SCALAR-SD-OR"],"kind":"boundary","summary":"SD.OR reads T and U relative sources with relaxed local defaults","pass_condition":"relative sources, default modifiers, memory, ordering, reservation, queues, and TPC match the SD.OR contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSDORRelativeDefaultForm()
begin

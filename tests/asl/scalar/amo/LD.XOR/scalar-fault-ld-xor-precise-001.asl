// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-XOR-PRECISE-001","source":"asl/scalar/amo/LD.XOR.asl","requirements":["PTO-INST-SCALAR-LD-XOR"],"kind":"fault","summary":"LD.XOR alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LD.XOR contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLDXORPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLDXORPreciseAlignmentFault();
    return 0;
end;

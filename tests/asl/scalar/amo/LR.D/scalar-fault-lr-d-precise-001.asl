// PTO-TEST: {"id":"PTO-AVS-SCALAR-LR-D-PRECISE-001","source":"asl/scalar/amo/LR.D.asl","requirements":["PTO-INST-SCALAR-LR-D"],"kind":"fault","summary":"LR.D access fault preserves the prior reservation and destination","pass_condition":"trap routing, destination, event, prior reservation, and recovery match the LR.D contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLRDPreciseFault()
begin

// PTO-TEST: {"id":"PTO-AVS-SCALAR-SW-OR-PRECISE-001","source":"asl/scalar/amo/SW.OR.asl","requirements":["PTO-INST-SCALAR-SW-OR"],"kind":"fault","summary":"SW.OR alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SW.OR contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSWORPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckSWORPreciseAlignmentFault();
    return 0;
end;

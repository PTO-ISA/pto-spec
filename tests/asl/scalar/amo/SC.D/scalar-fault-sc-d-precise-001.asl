// PTO-TEST: {"id":"PTO-AVS-SCALAR-SC-D-PRECISE-001","source":"asl/scalar/amo/SC.D.asl","requirements":["PTO-INST-SCALAR-SC-D"],"kind":"fault","summary":"SC.D line-matched access fault clears the reservation without publishing status","pass_condition":"trap, memory, destination, event, reservation clear, and recovery match the SC.D contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSCDPreciseFault()
begin

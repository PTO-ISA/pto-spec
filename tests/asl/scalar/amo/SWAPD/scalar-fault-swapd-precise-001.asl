// PTO-TEST: {"id":"PTO-AVS-SCALAR-SWAPD-PRECISE-001","source":"asl/scalar/amo/SWAPD.asl","requirements":["PTO-INST-SCALAR-SWAPD"],"kind":"fault","summary":"SWAPD access fault is precise and preserves prior state","pass_condition":"trap, memory, destination, event, reservation, and recovery match the SWAPD contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSWAPDPreciseFault()
begin

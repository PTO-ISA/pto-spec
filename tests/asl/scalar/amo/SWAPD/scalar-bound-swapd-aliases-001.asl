// PTO-TEST: {"id":"PTO-AVS-SCALAR-SWAPD-ALIASES-001","source":"asl/scalar/amo/SWAPD.asl","requirements":["PTO-INST-SCALAR-SWAPD"],"kind":"boundary","summary":"SWAPD reads T and U sources and pushes the prior value to U","pass_condition":"relative sources, U push, relaxed order, nonoverlap reservation, and TPC match the SWAPD contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSWAPDAliases()
begin

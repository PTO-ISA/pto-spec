// PTO-TEST: {"id":"PTO-AVS-SCALAR-LW-UMIN-FORMS-001","source":"asl/scalar/amo/LW.UMIN.asl","requirements":["PTO-INST-SCALAR-LW-UMIN"],"kind":"boundary","summary":"LW.UMIN reads T and U sources and pushes its result to U with default modifiers","pass_condition":"relative sources, U push, relaxed ordering, nonoverlap reservation, and TPC match the LW.UMIN contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckLWUMINRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckLWUMINRelativeDefaultForm();
    return 0;
end;

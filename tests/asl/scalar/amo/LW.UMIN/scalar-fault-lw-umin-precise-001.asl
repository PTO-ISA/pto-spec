// PTO-TEST: {"id":"PTO-AVS-SCALAR-LW-UMIN-PRECISE-001","source":"asl/scalar/amo/LW.UMIN.asl","requirements":["PTO-INST-SCALAR-LW-UMIN"],"kind":"fault","summary":"LW.UMIN alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LW.UMIN contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLWUMINPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLWUMINPreciseAlignmentFault();
    return 0;
end;

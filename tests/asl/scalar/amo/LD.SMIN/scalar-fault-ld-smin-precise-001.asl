// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-SMIN-PRECISE-001","source":"asl/scalar/amo/LD.SMIN.asl","requirements":["PTO-INST-SCALAR-LD-SMIN"],"kind":"fault","summary":"LD.SMIN alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LD.SMIN contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLDSMINPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLDSMINPreciseAlignmentFault();
    return 0;
end;

// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-UMIN-FORMS-001","source":"asl/scalar/amo/SD.UMIN.asl","requirements":["PTO-INST-SCALAR-SD-UMIN"],"kind":"boundary","summary":"SD.UMIN reads T and U relative sources with relaxed local defaults","pass_condition":"relative sources, default modifiers, memory, ordering, reservation, queues, and TPC match the SD.UMIN contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSDUMINRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckSDUMINRelativeDefaultForm();
    return 0;
end;

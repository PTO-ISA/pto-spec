// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-UMIN-PRECISE-001","source":"asl/scalar/amo/SD.UMIN.asl","requirements":["PTO-INST-SCALAR-SD-UMIN"],"kind":"fault","summary":"SD.UMIN alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SD.UMIN contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSDUMINPreciseAlignmentFault()
begin
    ...
    var instruction: bits(48) = Zeros{48} + 0x7000500b;
...
begin
    ResetProfileState();
    CheckSDUMINPreciseAlignmentFault();
    return 0;
end;

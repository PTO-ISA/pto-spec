// PTO-TEST: {"id":"PTO-AVS-SCALAR-LR-H-ALIASES-001","source":"asl/scalar/amo/LR.H.asl","requirements":["PTO-INST-SCALAR-LR-H"],"kind":"boundary","summary":"LR.H accepts every SrcZero alias and Reg5 queue source and destination","pass_condition":"ignored SrcZero, T address source, U destination, relaxed order, reservation, and TPC match the LR.H contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckLRHAliases()
begin

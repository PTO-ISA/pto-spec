// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-ADD-FORMS-001","source":"asl/scalar/amo/LD.ADD.asl","requirements":["PTO-INST-SCALAR-LD-ADD"],"kind":"boundary","summary":"LD.ADD reads T and U sources and pushes its result to U with default modifiers","pass_condition":"relative sources, U push, relaxed ordering, nonoverlap reservation, and TPC match the LD.ADD contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckLDADDRelativeDefaultForm()
begin

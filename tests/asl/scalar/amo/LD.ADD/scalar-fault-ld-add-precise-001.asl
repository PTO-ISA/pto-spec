// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-ADD-PRECISE-001","source":"asl/scalar/amo/LD.ADD.asl","requirements":["PTO-INST-SCALAR-LD-ADD"],"kind":"fault","summary":"LD.ADD alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LD.ADD contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLDADDPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLDADDPreciseAlignmentFault();
    return 0;
end;

// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-SMAX-PRECISE-001","source":"asl/scalar/amo/SD.SMAX.asl","requirements":["PTO-INST-SCALAR-SD-SMAX"],"kind":"fault","summary":"SD.SMAX alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SD.SMAX contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSDSMAXPreciseAlignmentFault()
begin
    ...
    var instruction: bits(48) = Zeros{48} + 0x4000500b;
...
begin
    ResetProfileState();
    CheckSDSMAXPreciseAlignmentFault();
    return 0;
end;

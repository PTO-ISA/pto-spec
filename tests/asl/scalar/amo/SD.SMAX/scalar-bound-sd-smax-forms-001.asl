// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-SMAX-FORMS-001","source":"asl/scalar/amo/SD.SMAX.asl","requirements":["PTO-INST-SCALAR-SD-SMAX"],"kind":"boundary","summary":"SD.SMAX reads T and U relative sources with relaxed local defaults","pass_condition":"relative sources, default modifiers, memory, ordering, reservation, queues, and TPC match the SD.SMAX contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSDSMAXRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckSDSMAXRelativeDefaultForm();
    return 0;
end;

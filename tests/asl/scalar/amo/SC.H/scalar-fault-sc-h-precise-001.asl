// PTO-TEST: {"id":"PTO-AVS-SCALAR-SC-H-PRECISE-001","source":"asl/scalar/amo/SC.H.asl","requirements":["PTO-INST-SCALAR-SC-H"],"kind":"fault","summary":"SC.H line-matched access fault clears the reservation without publishing status","pass_condition":"trap, memory, destination, event, reservation clear, and recovery match the SC.H contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSCHPreciseFault()
begin

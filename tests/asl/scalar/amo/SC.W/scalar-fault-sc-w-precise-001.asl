// PTO-TEST: {"id":"PTO-AVS-SCALAR-SC-W-PRECISE-001","source":"asl/scalar/amo/SC.W.asl","requirements":["PTO-INST-SCALAR-SC-W"],"kind":"fault","summary":"SC.W line-matched access fault clears the reservation without publishing status","pass_condition":"trap, memory, destination, event, reservation clear, and recovery match the SC.W contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSCWPreciseFault()
begin

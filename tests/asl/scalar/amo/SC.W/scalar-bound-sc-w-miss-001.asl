...
begin
    ...
    assert InstructionContractMissStatus_SC_W() == Zeros{PTO_XLEN} + 1;
    assert InstructionContractMissIsProbeFree_SC_W();
end;

func main() => integer
begin
    ResetProfileState();
    CheckSCWProbeFreeMiss();
    return 0;
end;

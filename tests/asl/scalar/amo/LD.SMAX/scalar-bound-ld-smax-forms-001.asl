// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-SMAX-FORMS-001","source":"asl/scalar/amo/LD.SMAX.asl","requirements":["PTO-INST-SCALAR-LD-SMAX"],"kind":"boundary","summary":"LD.SMAX reads T and U sources and pushes its result to U with default modifiers","pass_condition":"relative sources, U push, relaxed ordering, nonoverlap reservation, and TPC match the LD.SMAX contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckLDSMAXRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckLDSMAXRelativeDefaultForm();
    return 0;
end;

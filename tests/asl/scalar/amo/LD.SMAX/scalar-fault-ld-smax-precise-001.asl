// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-SMAX-PRECISE-001","source":"asl/scalar/amo/LD.SMAX.asl","requirements":["PTO-INST-SCALAR-LD-SMAX"],"kind":"fault","summary":"LD.SMAX alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LD.SMAX contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLDSMAXPreciseAlignmentFault()
begin
    ...
    assert LoadTranslatedUnsigned(aligned_address, 8) == old_value;
...
begin
    ResetProfileState();
    CheckLDSMAXPreciseAlignmentFault();
    return 0;
end;

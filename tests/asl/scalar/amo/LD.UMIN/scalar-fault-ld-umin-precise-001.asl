// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-UMIN-PRECISE-001","source":"asl/scalar/amo/LD.UMIN.asl","requirements":["PTO-INST-SCALAR-LD-UMIN"],"kind":"fault","summary":"LD.UMIN alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LD.UMIN contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLDUMINPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLDUMINPreciseAlignmentFault();
    return 0;
end;

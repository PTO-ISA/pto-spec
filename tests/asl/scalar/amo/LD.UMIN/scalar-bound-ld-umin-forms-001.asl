// PTO-TEST: {"id":"PTO-AVS-SCALAR-LD-UMIN-FORMS-001","source":"asl/scalar/amo/LD.UMIN.asl","requirements":["PTO-INST-SCALAR-LD-UMIN"],"kind":"boundary","summary":"LD.UMIN reads T and U sources and pushes its result to U with default modifiers","pass_condition":"relative sources, U push, relaxed ordering, nonoverlap reservation, and TPC match the LD.UMIN contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckLDUMINRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckLDUMINRelativeDefaultForm();
    return 0;
end;

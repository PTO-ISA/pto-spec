// PTO-TEST: {"id":"PTO-AVS-SCALAR-SW-SMIN-FORMS-001","source":"asl/scalar/amo/SW.SMIN.asl","requirements":["PTO-INST-SCALAR-SW-SMIN"],"kind":"boundary","summary":"SW.SMIN reads T and U relative sources with relaxed local defaults","pass_condition":"relative sources, default modifiers, memory, ordering, reservation, queues, and TPC match the SW.SMIN contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSWSMINRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckSWSMINRelativeDefaultForm();
    return 0;
end;

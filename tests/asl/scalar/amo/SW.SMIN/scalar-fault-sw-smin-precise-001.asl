// PTO-TEST: {"id":"PTO-AVS-SCALAR-SW-SMIN-PRECISE-001","source":"asl/scalar/amo/SW.SMIN.asl","requirements":["PTO-INST-SCALAR-SW-SMIN"],"kind":"fault","summary":"SW.SMIN alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SW.SMIN contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSWSMINPreciseAlignmentFault()
begin
    ...
    var instruction: bits(48) = Zeros{48} + 0x5000300b;
...
begin
    ResetProfileState();
    CheckSWSMINPreciseAlignmentFault();
    return 0;
end;

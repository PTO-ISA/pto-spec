// PTO-TEST: {"id":"PTO-AVS-SCALAR-SWAPH-ALIASES-001","source":"asl/scalar/amo/SWAPH.asl","requirements":["PTO-INST-SCALAR-SWAPH"],"kind":"boundary","summary":"SWAPH reads T and U sources and pushes the prior value to U","pass_condition":"relative sources, U push, relaxed order, nonoverlap reservation, and TPC match the SWAPH contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSWAPHAliases()
begin

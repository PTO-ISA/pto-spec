// PTO-TEST: {"id":"PTO-AVS-SCALAR-SW-UMAX-PRECISE-001","source":"asl/scalar/amo/SW.UMAX.asl","requirements":["PTO-INST-SCALAR-SW-UMAX"],"kind":"fault","summary":"SW.UMAX alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SW.UMAX contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSWUMAXPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckSWUMAXPreciseAlignmentFault();
    return 0;
end;

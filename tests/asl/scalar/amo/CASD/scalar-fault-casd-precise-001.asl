// PTO-TEST: {"id":"PTO-AVS-SCALAR-CASD-PRECISE-001","source":"asl/scalar/amo/CASD.asl","requirements":["PTO-INST-SCALAR-CASD"],"kind":"fault","summary":"CASD access fault is precise and preserves destination and reservation","pass_condition":"trap, memory, event, destination, reservation, recovery, and TPC match the CASD contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckCASDPreciseFault()
begin

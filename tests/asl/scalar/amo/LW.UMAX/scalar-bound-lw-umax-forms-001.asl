// PTO-TEST: {"id":"PTO-AVS-SCALAR-LW-UMAX-FORMS-001","source":"asl/scalar/amo/LW.UMAX.asl","requirements":["PTO-INST-SCALAR-LW-UMAX"],"kind":"boundary","summary":"LW.UMAX reads T and U sources and pushes its result to U with default modifiers","pass_condition":"relative sources, U push, relaxed ordering, nonoverlap reservation, and TPC match the LW.UMAX contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckLWUMAXRelativeDefaultForm()
begin
...
begin
    ResetProfileState();
    CheckLWUMAXRelativeDefaultForm();
    return 0;
end;

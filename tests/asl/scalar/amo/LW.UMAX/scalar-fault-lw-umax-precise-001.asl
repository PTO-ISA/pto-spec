// PTO-TEST: {"id":"PTO-AVS-SCALAR-LW-UMAX-PRECISE-001","source":"asl/scalar/amo/LW.UMAX.asl","requirements":["PTO-INST-SCALAR-LW-UMAX"],"kind":"fault","summary":"LW.UMAX alignment fault is precise and restores the original TPC","pass_condition":"trap routing, destination, memory, event, reservation, queues, and recovery match the LW.UMAX contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLWUMAXPreciseAlignmentFault()
begin
...
begin
    ResetProfileState();
    CheckLWUMAXPreciseAlignmentFault();
    return 0;
end;

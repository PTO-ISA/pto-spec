// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-AND-FORMS-001","source":"asl/scalar/amo/SD.AND.asl","requirements":["PTO-INST-SCALAR-SD-AND"],"kind":"boundary","summary":"SD.AND reads T and U relative sources with relaxed local defaults","pass_condition":"relative sources, default modifiers, memory, ordering, reservation, queues, and TPC match the SD.AND contract","related_sources":["asl/scalar/model/types/operands.asl","asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl"]}
func CheckSDANDRelativeDefaultForm()
begin

// PTO-TEST: {"id":"PTO-AVS-SCALAR-HL-CASW-PRECISE-001","source":"asl/scalar/amo/HL.CASW.asl","requirements":["PTO-INST-SCALAR-HL-CASW"],"kind":"fault","summary":"HL.CASW access fault is precise and preserves destination and reservation","pass_condition":"trap, memory, event, destination, reservation, recovery, and TPC match the HL.CASW contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckHL_CASWPreciseFault()
begin

// PTO-TEST: {"id":"PTO-AVS-SCALAR-SD-XOR-PRECISE-001","source":"asl/scalar/amo/SD.XOR.asl","requirements":["PTO-INST-SCALAR-SD-XOR"],"kind":"fault","summary":"SD.XOR alignment fault is precise and restores the original TPC","pass_condition":"trap routing, saved context, memory, event, reservation, register, queue, and recovery state match the SD.XOR contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckSDXORPreciseAlignmentFault()
begin
    ...
    var instruction: bits(48) = Zeros{48} + 0x3000500b;
...
begin
    ResetProfileState();
    CheckSDXORPreciseAlignmentFault();
    return 0;
end;

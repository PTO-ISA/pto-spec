// PTO-TEST: {"id":"PTO-AVS-SCALAR-LR-B-PRECISE-001","source":"asl/scalar/amo/LR.B.asl","requirements":["PTO-INST-SCALAR-LR-B"],"kind":"fault","summary":"LR.B access fault preserves the prior reservation and destination","pass_condition":"trap routing, destination, event, prior reservation, and recovery match the LR.B contract","related_sources":["asl/scalar/model/dispatch/amo.asl","asl/scalar/model/amo/semantics.asl","asl/arch/memory-model/fault-precision.asl"]}
func CheckLRBPreciseFault()
begin

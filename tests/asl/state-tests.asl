...
begin
    ...
    _ReturnAddress = Zeros{PTO_XLEN} + 0x7700;
    ...
    // EBSTATE-only fields below are intentionally not portable serialized by
    // EBARG. Mutating live state after save must not affect recovered state.
    ...
    _PredicateRegisters[[1]] = Zeros{PTO_PREDICATE_WIDTH};

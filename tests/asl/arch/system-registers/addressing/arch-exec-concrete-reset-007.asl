// PTO-TEST: {"id":"PTO-AVS-ARCH-CONCRETE-RESET-EXEC-007","source":"asl/arch/system-registers/addressing.asl","requirements":[],"kind":"execution","summary":"reference-profile reset clears every architectural state family","pass_condition":"reset state, memory, Tile, reservation, and context assertions hold","related_sources":[]}

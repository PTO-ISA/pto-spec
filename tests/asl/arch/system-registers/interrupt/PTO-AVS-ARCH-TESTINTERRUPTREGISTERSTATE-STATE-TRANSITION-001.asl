...
// PTO-TEST: {"id":"PTO-AVS-ARCH-TESTINTERRUPTREGISTERSTATE-STATE-TRANSITION-001","source":"asl/arch/system-registers/interrupt.asl","requirements":[],"kind":"state-transition","summary":"migrated independent behavior point for TestInterruptRegisterState","pass_condition":"TestInterruptRegisterState completes without assertion failure","related_sources":[]}

...
// PTO-TEST: {"id":"PTO-AVS-ARCH-TESTTSOCONCURRENCY-ORDERING-001","source":"asl/arch/memory-model/ordering.asl","requirements":[],"kind":"ordering","summary":"Covers TSO Concurrency.","pass_condition":"TestTSOConcurrency completes without assertion failure","related_sources":[]}

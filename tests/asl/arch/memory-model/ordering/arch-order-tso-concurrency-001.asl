// PTO-TEST: {"id":"PTO-AVS-ARCH-TSO-CONCURRENCY-ORDER-001","source":"asl/arch/memory-model/ordering.asl","requirements":[],"kind":"ordering","summary":"TSO concurrency outcomes obey store, fence, and atomic ordering","pass_condition":"TSO concurrency assertions hold","related_sources":[]}

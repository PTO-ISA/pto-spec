...
// PTO-TEST: {"id":"PTO-AVS-ARCH-TESTCROSSDISPATCHEXECUTIONCONTRACT-EXECUTION-001","source":"asl/arch/dispatch/top-level.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestCrossDispatchExecutionContract","pass_condition":"TestCrossDispatchExecutionContract completes without assertion failure","related_sources":[]}

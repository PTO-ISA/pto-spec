// PTO-TEST: {"id":"PTO-AVS-ARCH-TCVT-CONVERSION-EXECUTION-001","source":"asl/arch/profile/tcvt-conversion.asl","requirements":["PTO-TCVT-CONTRACT-001"],"kind":"execution","summary":"TCVT profile routes packed, E6M2, and reciprocal values through their exact numeric paths","pass_condition":"legal profile pairs produce the frozen result carriers and flags, special values map to their canonical destinations, and mode legality rejects unsupported E6M2 modes","related_sources":["asl/arch/profile/e8m0-conversion.asl","asl/arch/data-types/formats/rcpe6m2.asl"]}
func main() => integer
begin

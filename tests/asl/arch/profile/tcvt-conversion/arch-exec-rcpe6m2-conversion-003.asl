// PTO-TEST: {"id":"PTO-AVS-ARCH-RCPE6M2-CONVERSION-EXECUTION-003","source":"asl/arch/profile/tcvt-conversion.asl","requirements":["PTO-TCVT-CONTRACT-001","PTO-NUMERIC-RCPE6M2-FORMAT-001"],"kind":"execution","summary":"RCPE6M2 performs one final destination rounding from exact E6M2 reciprocals","pass_condition":"The required reciprocal values, BF16/FP16 final-round regression, overflow boundaries, subnormal endpoint, NaN mapping, and source-only legality return exact carriers and flags","related_sources":["asl/arch/data-types/formats/e6m2.asl","asl/arch/data-types/formats/rcpe6m2.asl","asl/arch/profile/matrix-quantization.asl"]}

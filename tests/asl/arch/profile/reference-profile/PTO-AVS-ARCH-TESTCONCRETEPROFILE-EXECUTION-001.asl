...
// PTO-TEST: {"id":"PTO-AVS-ARCH-TESTCONCRETEPROFILE-EXECUTION-001","source":"asl/arch/profile/reference-profile.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestConcreteProfile","pass_condition":"TestConcreteProfile completes without assertion failure","related_sources":[]}

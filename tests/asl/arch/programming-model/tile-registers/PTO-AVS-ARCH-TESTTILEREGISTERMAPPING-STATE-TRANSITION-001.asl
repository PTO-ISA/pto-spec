...
// PTO-TEST: {"id":"PTO-AVS-ARCH-TESTTILEREGISTERMAPPING-STATE-TRANSITION-001","source":"asl/arch/programming-model/tile-registers.asl","requirements":[],"kind":"state-transition","summary":"migrated independent behavior point for TestTileRegisterMapping","pass_condition":"TestTileRegisterMapping completes without assertion failure","related_sources":[]}

...
// PTO-TEST: {"id":"PTO-AVS-ARCH-TESTSCALARTEMPORARYQUEUES-EXECUTION-001","source":"asl/arch/programming-model/scalar-registers.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestScalarTemporaryQueues","pass_condition":"TestScalarTemporaryQueues completes without assertion failure","related_sources":[]}

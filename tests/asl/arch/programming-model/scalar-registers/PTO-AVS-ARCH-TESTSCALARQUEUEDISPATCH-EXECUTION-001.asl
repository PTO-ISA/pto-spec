...
// PTO-TEST: {"id":"PTO-AVS-ARCH-TESTSCALARQUEUEDISPATCH-EXECUTION-001","source":"asl/arch/programming-model/scalar-registers.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestScalarQueueDispatch","pass_condition":"TestScalarQueueDispatch completes without assertion failure","related_sources":[]}

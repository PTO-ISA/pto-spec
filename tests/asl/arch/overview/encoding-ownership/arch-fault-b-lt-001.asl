// PTO-TEST: {"id":"PTO-AVS-ARCH-ENCODING-OWNERSHIP-B-LT-001","source":"asl/arch/overview/encoding-ownership.asl","requirements":["PTO-ARCH-ENCODING-OWNERSHIP-001"],"kind":"fault","summary":"The B.LT form is extension-reserved and rejects before scalar effects","pass_condition":"B.LT fails scalar decode and execution with IllegalInstruction while preserving control state","related_sources":["asl/arch/dispatch/top-level.asl"]}
func main() => integer
begin
    ResetProfileState();
    WriteTPC(Zeros{PTO_XLEN} + 0x100);
    var instruction: bits(48) = Zeros{48} + 0x00002027;

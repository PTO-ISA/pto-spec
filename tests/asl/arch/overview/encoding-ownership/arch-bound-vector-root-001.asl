...
func main() => integer
begin
    assert VectorExtensionRoot64Reserved(Zeros{32} + 0x0000007f);
    assert VectorExtensionRoot64Reserved(Zeros{32} + 0xffffffff);
    assert !VectorExtensionRoot64Reserved(Zeros{32} + 0x0000000f);
    assert !VectorExtensionRoot64Reserved(Zeros{32} + 0x00000013);
    return 0;
end;

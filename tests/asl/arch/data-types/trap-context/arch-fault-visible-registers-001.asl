...
// PTO-TEST: {"id":"PTO-AVS-ARCH-TESTVISIBLETRAPCONTEXTREGISTERS-FAULT-001","source":"asl/arch/data-types/trap-context.asl","requirements":[],"kind":"fault","summary":"Covers Visible Trap Context Registers.","pass_condition":"TestVisibleTrapContextRegisters completes without assertion failure","related_sources":[]}

...
// PTO-TEST: {"id":"PTO-AVS-ARCH-PROGRAM-COUNTER-STATE-001","source":"asl/arch/state/program-counter.asl","requirements":[],"kind":"state-transition","summary":"migrated independent behavior point for TestScalarState","pass_condition":"TestScalarState completes without assertion failure","related_sources":[]}

...
// PTO-TEST: {"id":"PTO-AVS-ARCH-TESTTRAPCONTEXTALLLEAFRECOVERYEVIDENCE-FAULT-001","source":"asl/arch/state/trap-context.asl","requirements":[],"kind":"fault","summary":"migrated independent behavior point for TestTrapContextAllLeafRecoveryEvidence","pass_condition":"TestTrapContextAllLeafRecoveryEvidence completes without assertion failure","related_sources":[]}

...
// PTO-TEST: {"id":"PTO-AVS-ARCH-TESTTRAPROUTINGPOLICY-FAULT-001","source":"asl/arch/state/trap-context.asl","requirements":[],"kind":"fault","summary":"migrated independent behavior point for TestTrapRoutingPolicy","pass_condition":"TestTrapRoutingPolicy completes without assertion failure","related_sources":[]}

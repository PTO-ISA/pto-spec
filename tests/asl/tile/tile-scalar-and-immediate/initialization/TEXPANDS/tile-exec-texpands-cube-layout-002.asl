// PTO-TEST: {"id":"PTO-AVS-TILE-TEXPANDS-CUBE-LAYOUT-002","source":"asl/tile/tile-scalar-and-immediate/initialization/TEXPANDS.asl","requirements":["PTO-TEXPANDS-CONTRACT-001","PTO-B-DATR-FIELDS-001"],"kind":"execution","summary":"TEXPANDS uses direct B.DATR Layout 29 to allocate and fill a CUBE_M32 destination without a Tile source.","pass_condition":"a two-column U32 TEXPANDS with Layout 29 publishes a defined CUBE_M32 destination with the scalar value in every valid logical element.","related_sources":["asl/block/model/dispatch/tile-scalar-schema.asl","asl/block/model/dispatch/destination-shape.asl","asl/block/model/state/control-state.asl"]}

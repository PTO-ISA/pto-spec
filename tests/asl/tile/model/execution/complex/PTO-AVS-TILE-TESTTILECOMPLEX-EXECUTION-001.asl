...
// PTO-TEST: {"id":"PTO-AVS-TILE-TESTTILECOMPLEX-EXECUTION-001","source":"asl/tile/model/execution/complex.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestTileComplex","pass_condition":"TestTileComplex completes without assertion failure","related_sources":[]}

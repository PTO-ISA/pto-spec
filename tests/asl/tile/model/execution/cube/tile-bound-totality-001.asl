...
// PTO-TEST: {"id":"PTO-AVS-TILE-TESTCUBETOTALITY-BOUNDARY-001","source":"asl/tile/model/execution/cube.asl","requirements":[],"kind":"boundary","summary":"Covers Cube Totality.","pass_condition":"TestCubeTotality completes without assertion failure","related_sources":[]}

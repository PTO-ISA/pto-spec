// PTO-TEST: {"id":"PTO-AVS-ARCH-REFERENCE-MATRIX-015","source":"asl/tile/model/execution/cube.asl","requirements":[],"kind":"execution","summary":"the reference profile performs ordinary floating Matrix accumulation and bias on numeric values rather than raw carrier integers","pass_condition":"FP32, FP16, and BF16 inputs accumulate into FP32 with per-operation rounding while integer inputs retain integer arithmetic","related_sources":["asl/tile/model/execution/cube.asl"]}
func main() => integer
begin

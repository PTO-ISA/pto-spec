// PTO-TEST: {"id":"PTO-AVS-TILE-EXECUTION-MASK-COMPARE-001","source":"asl/tile/model/execution/execution-mask-comparison.asl","requirements":["PTO-TILE-MODEL-EXECUTION-MASK-APPLICABILITY-001"],"kind":"execution","summary":"Predicated CUBE comparison skips inactive source lanes and applies predicate MERGE or ZERO","pass_condition":"active comparisons produce canonical predicate cells and status, inactive undefined sources are not read, PredicateCell MERGE preserves the prior coordinate, ZERO clears it, and GPR valid bits follow the same rule","related_sources":["asl/tile/model/execution/predicate-carriers.asl","asl/tile/model/legality/predicate-carriers.asl"]}
func main() => integer
begin
    ResetProfileState();

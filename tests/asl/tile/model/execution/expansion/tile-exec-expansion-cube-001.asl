// PTO-TEST: {"id":"PTO-AVS-TILE-EXPANSION-CUBE-001","source":"asl/tile/model/execution/expansion.asl","requirements":["PTO-TROWEXPAND-CONTRACT-001","PTO-TCOLEXPAND-CONTRACT-001","PTO-TEXPANDS-CONTRACT-001"],"kind":"execution","summary":"CUBE expansion uses logical broadcast extents, preserves same-layout legality, and permits capacities above 2KB; TEXPANDS selects a new CUBE destination layout.","pass_condition":"A CUBE_M16 row broadcast with physical columns greater than one executes, mixed layouts reject, a 4KB expansion source is accepted, and scalar expansion fills an explicit CUBE_M32 destination.","related_sources":["asl/tile/model/legality/reduction-and-expansion.asl","asl/block/model/dispatch/destination-shape.asl","asl/tile/model/legality/operand-schema.asl"]}

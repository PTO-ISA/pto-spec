// PTO-TEST: {"id":"PTO-AVS-ARCH-CONCRETE-TILE-EXEC-006","source":"asl/tile/model/execution/elementwise.asl","requirements":[],"kind":"execution","summary":"reference-profile Tile arithmetic and trap recovery are exact","pass_condition":"Tile profile and trap recovery assertions hold","related_sources":[]}

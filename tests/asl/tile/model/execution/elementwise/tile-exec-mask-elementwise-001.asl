// PTO-TEST: {"id":"PTO-AVS-TILE-EXECUTION-MASK-ELEMENTWISE-001","source":"asl/tile/model/execution/elementwise.asl","requirements":["PTO-TILE-MODEL-EXECUTION-MASK-APPLICABILITY-001"],"kind":"execution","summary":"Elementwise ExecutionMask skips inactive source lanes and applies ZERO or MERGE","pass_condition":"undefined inactive source elements do not reject or get read, active elements execute, inactive MERGE copies the old destination, and ZERO writes zero","related_sources":["asl/tile/model/legality/execution-mask-source-schema.asl","asl/tile/model/execution/execution-mask-state.asl"]}
func main() => integer
begin
    ResetProfileState();

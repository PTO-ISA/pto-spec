// PTO-TEST: {"id":"PTO-AVS-TILE-EXECUTION-MASK-PACK-001","source":"asl/tile/model/execution/rearrangement.asl","requirements":["PTO-REQ-TEPL-PREDICATE-CARRIER-001","PTO-REQ-TEPL-REARRANGE-001"],"kind":"execution","summary":"TPACK reads active words only and applies ExecutionMask MERGE/ZERO per CUBE cell","pass_condition":"active word packs, undefined inactive source words do not reject, MERGE preserves old inactive destination, and ZERO writes zero without reading any source word","related_sources":["asl/tile/model/legality/layout-rearrangement.asl","asl/tile/model/execution/execution-mask-state.asl"]}
func main() => integer
begin
    ResetProfileState();

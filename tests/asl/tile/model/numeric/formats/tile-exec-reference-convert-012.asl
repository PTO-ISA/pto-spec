// PTO-TEST: {"id":"PTO-AVS-ARCH-REFERENCE-CONVERT-012","source":"asl/tile/model/numeric/formats.asl","requirements":[],"kind":"execution","summary":"the reference profile converts finite FP32, FP64, signed integer, and unsigned integer carriers","pass_condition":"FP width conversion and both integer conversion directions produce the fixed RNE or RTZ result and flags","related_sources":["asl/scalar/model/fsu/reference-quantization.asl"]}
func main() => integer
begin

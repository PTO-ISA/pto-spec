// PTO-TEST: {"id":"PTO-AVS-ARCH-PACKED-CONVERSION-BOUNDARIES-002","source":"asl/tile/model/numeric/packed-conversion.asl","requirements":["PTO-TCVT-CONTRACT-001"],"kind":"boundary","summary":"Packed FP4 reference conversion covers complete code sets, signed special values, and rounding boundaries","pass_condition":"All E2M1 and S1P2 values, midpoint controls, endpoint overflow, NaN/Infinity policy, signed zero, and exact reverse conversions return the frozen carriers and flags","related_sources":["asl/arch/data-types/formats/e1m2x2.asl","asl/arch/data-types/formats/e2m1x2.asl","asl/tile/model/numeric/tcvt-conversion.asl"]}

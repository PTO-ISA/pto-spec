...
// PTO-TEST: {"id":"PTO-AVS-TILE-TESTTILEMEMORYCOMPLETIONANDRESTART-EXECUTION-001","source":"asl/tile/model/memory/restart.asl","requirements":[],"kind":"execution","summary":"migrated independent behavior point for TestTileMemoryCompletionAndRestart","pass_condition":"TestTileMemoryCompletionAndRestart completes without assertion failure","related_sources":[]}

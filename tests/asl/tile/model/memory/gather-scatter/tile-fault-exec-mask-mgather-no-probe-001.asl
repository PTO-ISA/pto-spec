// PTO-TEST: {"id":"PTO-AVS-TILE-EXECUTION-MASK-MGATHER-NO-PROBE-001","source":"asl/tile/model/memory/gather-scatter.asl","requirements":["PTO-TILE-MODEL-EXECUTION-MASK-APPLICABILITY-001","PTO-INST-TILE-MGATHER"],"kind":"fault","summary":"MGATHER skips inactive indexed addresses before memory probes","pass_condition":"the active indexed load completes while an inactive index points into an unmapped page without a fault or event; the inactive result is ZERO","related_sources":["asl/tile/model/legality/memory-schema.asl","asl/tile/model/execution/execution-mask-state.asl"]}
func main() => integer
begin
    ResetProfileState();

...
// PTO-TEST: {"id":"PTO-AVS-TILE-TESTTILECAPACITYLEGALITY-BOUNDARY-001","source":"asl/tile/model/legality/allocation-capacity.asl","requirements":[],"kind":"boundary","summary":"migrated independent behavior point for TestTileCapacityLegality","pass_condition":"TestTileCapacityLegality completes without assertion failure","related_sources":[]}

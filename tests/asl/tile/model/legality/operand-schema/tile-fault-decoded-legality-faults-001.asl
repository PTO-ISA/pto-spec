...
// PTO-TEST: {"id":"PTO-AVS-TILE-TESTDECODEDTILELEGALITYFAULTS-FAULT-001","source":"asl/tile/model/legality/operand-schema.asl","requirements":[],"kind":"fault","summary":"Covers Decoded Tile Legality Faults.","pass_condition":"TestDecodedTileLegalityFaults completes without assertion failure","related_sources":[]}

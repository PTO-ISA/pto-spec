...
// PTO-TEST: {"id":"PTO-AVS-TILE-TESTMATRIXNUMERICCONTRACTLEGALITY-BOUNDARY-001","source":"asl/tile/model/legality/matrix-shape.asl","requirements":[],"kind":"boundary","summary":"migrated independent behavior point for TestMatrixNumericContractLegality","pass_condition":"TestMatrixNumericContractLegality completes without assertion failure","related_sources":[]}

...
// PTO-TEST: {"id":"PTO-AVS-TILE-TESTTILEELEMENTDEFINEDNESS-EXECUTION-001","source":"asl/tile/model/definedness/elements.asl","requirements":[],"kind":"execution","summary":"Covers Tile Element Definedness.","pass_condition":"TestTileElementDefinedness completes without assertion failure","related_sources":[]}

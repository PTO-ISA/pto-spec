...
// PTO-TEST: {"id":"PTO-AVS-TILE-TESTVECSFUCARRIERTOTALITY-BOUNDARY-001","source":"asl/tile/model/dispatch/top-level.asl","requirements":[],"kind":"boundary","summary":"Covers Vec Sfu Carrier Totality.","pass_condition":"TestVecSfuCarrierTotality completes without assertion failure","related_sources":[]}
...
begin
    ...
    elsif data_type == TileDataType_U16 then
        capacity_bytes = if columns > 32 then 2048 else 256;
...
begin
    ...
    if TeplOperationIsRowReduction(operation) then
        ...
        ConfigureTeplTile(0, 1, 2, TileDataType_U16);
...
func TestVecSfuCarrierTotality()
begin

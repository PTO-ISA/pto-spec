...
// PTO-TEST: {"id":"PTO-AVS-TILE-TESTTEPLTOTALITY-BOUNDARY-001","source":"asl/tile/model/dispatch/tile-tile-elementwise.asl","requirements":[],"kind":"boundary","summary":"migrated independent behavior point for TestTeplTotality","pass_condition":"TestTeplTotality completes without assertion failure","related_sources":[]}

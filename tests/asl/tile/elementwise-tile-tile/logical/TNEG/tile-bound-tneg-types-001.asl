...
begin
    ...
    assert InstructionContractDataTypeLegal_TNEG(TileDataType_TF32);
    assert InstructionContractDataTypeLegal_TNEG(TileDataType_HF32);
    ...
    assert InstructionContractDataTypeLegal_TNEG(TileDataType_E4M3);
    assert InstructionContractDataTypeLegal_TNEG(TileDataType_E5M2);
    assert InstructionContractDataTypeLegal_TNEG(TileDataType_S64);
    ...
    assert InstructionContractDataTypeLegal_TNEG(TileDataType_U64);
    assert InstructionContractDataTypeLegal_TNEG(TileDataType_U32);
    assert InstructionContractDataTypeLegal_TNEG(TileDataType_U16);
    assert InstructionContractDataTypeLegal_TNEG(TileDataType_U8);

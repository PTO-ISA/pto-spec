// PTO-TEST: {"id":"PTO-AVS-TILE-TABS-SCHEMA-001","source":"asl/tile/elementwise-tile-tile/logical/TABS.asl","requirements":["PTO-TABS-CONTRACT-001"],"kind":"fault","summary":"TABS requires one terminal Local B.IOT.","pass_condition":"A split source and destination binding sequence raises TileLegality before effects for TABS.","related_sources":["asl/block/model/dispatch/tile-schema.asl"]}
func main() => integer
begin
    ResetProfileState();

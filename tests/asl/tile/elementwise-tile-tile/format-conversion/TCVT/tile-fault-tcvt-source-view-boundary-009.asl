// PTO-TEST: {"id":"PTO-AVS-TILE-TCVT-SOURCE-VIEW-BOUNDARY-009","source":"asl/tile/elementwise-tile-tile/format-conversion/TCVT.asl","requirements":["PTO-TCVT-CONTRACT-001","PTO-TILE-CARRIER-REINTERPRETATION-001"],"kind":"fault","summary":"TCVT source reinterpretation remains bounded by width, packing, type-pair, CUBE geometry, and definedness rules.","pass_condition":"Wrong-width, packed, RCPE6M2-to-FP32, explicit CUBE LB2, and undefined E8M0 source views fault before allocation while preserving capacity, source descriptor and payload, and numeric status.","related_sources":["asl/arch/profile/e8m0-conversion.asl","asl/block/model/dispatch/tcvt-schema.asl","asl/tile/model/legality/operand-schema.asl","asl/tile/model/numeric/formats.asl"]}
...
begin
    ...
    BeginRejectedSourceView(
        TileDataType_RCPE6M2, TileDataType_FP32, 1, 1, 8);
    AssertRejectedWithoutEffects(source_before, capacity_before);
end;

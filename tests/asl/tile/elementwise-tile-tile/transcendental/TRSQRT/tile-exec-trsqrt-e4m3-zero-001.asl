// PTO-TEST: {"id":"PTO-AVS-TILE-TRSQRT-E4M3ZERO-001","source":"asl/tile/elementwise-tile-tile/transcendental/TRSQRT.asl","requirements":["PTO-INST-TILE-TRSQRT"],"kind":"execution","summary":"TRSQRT maps E4M3 signed zero to canonical NaN","pass_condition":"both E4M3 zero signs produce canonical NaN and record only DZ","related_sources":["asl/tile/model/execution/unary.asl","asl/arch/features/mx-formats.asl"]}
func main() => integer
begin

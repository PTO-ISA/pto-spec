// PTO-TEST: {"id":"PTO-AVS-TILE-TMAX-SCHEMA-001","source":"asl/tile/elementwise-tile-tile/arithmetic/TMAX.asl","requirements":["PTO-TMAX-CONTRACT-001"],"kind":"fault","summary":"TMAX requires destination and both sources in one terminal B.IOT.","pass_condition":"A split two-record binding schema raises TileLegality before destination allocation or source mutation.","related_sources":["asl/block/model/dispatch/tile-schema.asl"]}
func main() => integer
begin
    ResetProfileState();

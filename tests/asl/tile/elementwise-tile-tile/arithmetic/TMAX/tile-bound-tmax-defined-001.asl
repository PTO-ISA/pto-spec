// PTO-TEST: {"id":"PTO-AVS-TILE-TMAX-DEFINED-001","source":"asl/tile/elementwise-tile-tile/arithmetic/TMAX.asl","requirements":["PTO-TMAX-CONTRACT-001"],"kind":"boundary","summary":"TMAX requires both source Tiles to be defined.","pass_condition":"An undefined right source rejects before destination effects.","related_sources":["asl/tile/model/legality/operand-schema.asl"]}
func main() => integer
begin
    ResetProfileState();

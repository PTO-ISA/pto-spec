// PTO-TEST: {"id":"PTO-AVS-TILE-TGEMV-BIAS-EXEC-001","source":"asl/tile/matrix-and-matrix-vector/matrix-vector/TGEMV_BIAS.asl","requirements":["PTO-TGEMV-BIAS-CONTRACT-001","PTO-INST-TILE-TGEMV-BIAS"],"kind":"execution","summary":"TGEMV_BIAS executes its direct 1x1 CUBE semantic handler","pass_condition":"the legal FP16 operands commit the expected FP32 result","related_sources":["asl/tile/model/legality/matrix-shape.asl","asl/tile/model/execution/cube.asl"]}
func SelectTGEMV_BIASFP16()
begin
...
begin
    ...
    assert TileOperandsLegal_TGEMV_BIAS(4, 1, 2, 3);
    TGEMV_BIAS(4, 1, 2, 3);
    ...
    assert !TileOperandsLegal_TGEMV_BIAS(4, 1, 2, 5);
    assert !TileOperandsLegal_TGEMV_BIAS(4, 1, 2, 6);
    assert !TileOperandsLegal_TGEMV_BIAS(4, 1, 2, 7);
    return 0;
end;

// PTO-TEST: {"id":"PTO-AVS-TILE-TMATMUL-MX-TYPES-001","source":"asl/tile/matrix-and-matrix-vector/matrix-matrix/TMATMUL_MX.asl","requirements":["PTO-INST-TILE-TMATMUL-MX","PTO-CUBE-MATRIX-SCALE-001"],"kind":"boundary","summary":"TMATMULMX accepts seven side types and derives scale kind per side.","pass_condition":"FP16 and BF16 omit scales; four MX compact formats require group-32 E8M0; HiF4X2 requires group-64 U32.","related_sources":["asl/tile/model/legality/matrix-shape.asl"]}
func main() => integer
begin
    ...
    assert TileMXInputTypeNeedsScale(TileDataType_HiF4X2);
    ...
    assert TileMXOperandPairLegal(
        TileDataType_HiF4X2, TileDataType_E2M1X2);

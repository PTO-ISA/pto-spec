...
begin
    ...
    assert DecodeTileOperation(TileDecode_CUBE, '000000000100') == 85;
    assert TileOperationOfIndex(85) == TileOperation_TMATMUL_MX;
    assert TileHandlerOfIndex(85) == TileHandler_TMATMUL_MX;
